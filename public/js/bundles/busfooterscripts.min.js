...
function ForgotPassword() {
    $("a#loginPopover").data("bs.popover").config.content = '<div class="row px-5 pt-5"><label for="email" class="innerPopover mb-0">E-Mail<\/label><input type="text" class= "form-control only-bottom p-0 h-auto" id="forgottenEmail" name="forgottenEmail"><\/div><div class="row px-5 py-2 text-right d-block"><b><a href="javascript:void(0)" onclick="LoginAfterForgot()" style="color:inherit; text-decoration: none;"><span class="forgotPopover">' + signInText + '<\/span><\/a><\/b><\/div><div class="row py-2 text-center d-block"><button type="button" id="forgottenButton" class="btn btn-success px-5">' + newPasswordText + "<\/button><\/div>";
    $("#loginPopover").data("bs.popover").show()
}
function LoginAfterForgot() {
    $("#loginPopover").data("bs.popover").config.content = '<div class="row px-5 pt-5"><label for="username" class="innerPopover mb-0">' + mailTCPhoneText + '<\/label><input type="text" class= "form-control only-bottom p-0 h-auto" id="username" name="username"><\/div><div class="row px-5 py-2"><label for="password" class="innerPopover mb-0">' + passwordText + '<\/label><input type="password" class= "form-control only-bottom p-0 h-auto" id="password" name="password"><\/div><div class="row pt-2 text-center d-block"><button type="button" class="btn btn-success px-5" onclick="Login()">' + loginText + '<\/button><\/div><div class="row text-center d-block pt-2"><div class="row px-5 py-2 text-right d-block"><b><a href="javascript:void(0)" onclick="ForgotPassword()" style="color:inherit; text-decoration: none;"><span class="forgotPopover">' + forgotPasswordText + "<\/span><\/a><\/b><\/div><\/div>";
    $("#loginPopover").data("bs.popover").show()
}
function ShowErrorMessage(n) {
    $("#warningMessageBox").text(n);
    $("#warningMessageModal").modal()
}
function ShowSuccessMessage(n) {
    $("#successMessageBox").text(n);
    $("#successMessageModal").modal()
}
function ShowModalMessage(n, t) {
    $("#dynamicModalTitle").text(n);
    $("#dynamicMessageBox").html(t);
    $("#dynamicMessageModal").modal()
}
function ShowImageMessage(n) {
    $("#image").attr("src", n);
    $("#imgModal").modal()
}
function showSpeedMenu(n) {
    console.log($("#" + n).hasClass("d-none"));
    var t = $("#" + n).hasClass("d-none");
    $(".speedMenu").addClass("d-none");
    t && $("#" + n).removeClass("d-none")
}
function SadeceHarfVeBosluk(n) {
    return /^[a-zA-Z çıüğöşİĞÜÖŞÇ.]+$/.test(n)
}
function TarihGetir(n) {
    var t = n.split("/")
      , i = ""
      , r = ""
      , u = "";
    ...
    r = t[1] - 1,
    u = t[2],
    parseInt(i) == 0 || parseInt(r) + 1 == 0 || parseInt(u) == 0) ? !1 : new Date(u,r,i)
}
function validateEmail(n) {
    return /^[\w\-\.\+]+\@[a-zA-Z0-9\.\-]+\.[a-zA-z0-9]{2,4}$/.test(n)
}
function validatePassword(n) {
    return /(?=.*[A-Za-z])(?=.*[0-9])[0-9a-zA-Z\W]{6,}$/.test(n)
}
function Guid(n) {
    return /^[A-Z0-9]{8}\-([A-Z0-9]{4}\-){3}[A-Z0-9]{12}$/.test(n)
}
function validateTC(n) {
    return /[0-9]{11}/.test(n)
}
function validateTarih(n) {
    return /((0?[1-9])|([12][0-9])|(3[01]))(\/)(0?[1-9]|1[0-2])(\/)(((1[9])|(2[0]))[0-9][0-9])$/.test(n)
}
function CheckTcNo(n) {
    var t;
    if (n.substr(0, 1) == 0 && n.lenght != 11)
        return !1;
    for (var r = 9, u = "", f = "", i, e = ""; i = n.charAt(--r); )
        r % 2 == 0 ? u += i : f += i;
    if (t = parseInt((eval(u.split("").join("+")) * 7 - eval(f.split("").join("+"))) % 10),
    t < 0 && (t += 10),
    t != parseInt(n.substr(9, 1), 10))
        return !1;
    for (c = 0; c <= 9; c++)
        e += n.charAt(c);
    return eval(e.split("").join("+")) % 10 != parseInt(n.substr(10, 1), 10) ? !1 : validateTC(n) == !1 ? !1 : !0
}
function GeriDon() {
    history.go(-1)
}
...
function dateFormat(n) {
    var t = n.split(" ")[0]
      , i = n.split(" ")[1];
    return {
        date: new Date(t.split(".")[2],parseInt(t.split(".")[1]) - 1,t.split(".")[0]),
        time: new Date(t.split(".")[2],parseInt(t.split(".")[1]) - 1,t.split(".")[0],i.split(":")[0],i.split(":")[1],i.split(":")[2])
    }
}
function validateEmail(n) {
    return /^[\w\-\.\+]+\@[a-zA-Z0-9\.\-]+\.[a-zA-z0-9]{2,4}$/.test(n)
...
function RegisterControl() {
    var n = !1
      , t = "";
    return $("#exampleCheck1").is(":checked") || (n = !0,
    t = "Kayıt olmak için Taşıma Kuralları'nı kabul etmelisiniz."),
    $("#exampleCheck2").is(":checked") || (n = !0,
    t = "Kayıt olmak için KVKK Kuralları'nı kabul etmelisiniz."),
    $("#adi").val() == "" && (n = !0,
    t = "Lütfen adınızı doldurunuz."),
    $("#soyadi").val() == "" && (n = !0,
    t = "Lütfen soyadınızı doldurunuz."),
    $("#uyruk").val() == "1" && ($("#cinsiyet").val() == "" && (n = !0,
    t = "Lütfen tüm alanları doldurunuz."),
    $("#birthdate").val() == "" && (n = !0,
    t = "Lütfen tüm alanları doldurunuz.")),
    $("#telefon").val() == "" && (n = !0,
    t = "Lütfen telefon numaranızı doldurunuz."),
    $("#email").val() == "" && (n = !0,
    t = "Lütfen email alanını doldurunuz."),
    ($("#birthdate").val() == "" || $("#birthdate").val().length != 10) && (n = !0,
    t = "Lütfen doğum tarihi alanını doldurunuz."),
    $("#passwordregister").val() == "" && (n = !0,
    t = "Lütfen şifre alanını doldurunuz."),
    $("#newpassword").val() == "" && (n = !0,
    t = "Lütfen şifre tekrar alanının doldurunuz."),
    validateEmail($("#email").val()) == !1 && (n = !0,
    t = "Lütfen geçerli bir mail giriniz."),
    validatePassword($("#passwordregister").val()) == !1 && (n = !0,
    t = "Lütfen geçerli bir parola giriniz."),
    validatePassword($("#newpassword").val()) == !1 && (n = !0,
    t = "Lütfen geçerli bir parola giriniz."),
    n ? (ShowErrorMessage(t),
    !1) : !0
}
function CheckTcNo(n) {
    var t;
...
function Register() {
    if (RegisterControl()) {
        ...
        $.ajax({
            ...
            success: function(n) {
                UnBlok();
                n != "" && n != undefined && n.isSuccess ? ShowSuccessMessage(n.statusMessage) : ShowErrorMessage(n.statusMessage)
            }
        })
    }
}
function Login() {
    ...
    $.ajax({
        ...
        success: function(n) {
            UnBlok();
            n.isSuccess ? window.location.href = "/tr/Bus/Myprofile" : ShowErrorMessage(n.statusMessage)
        }
    })
}
function UpdateUser() {
    var t = $("#telefon").val().trim().replaceAll(" ", ""), i = $("#tckimlikno").val(), r = $("#emailadres").val(), n;
    Blok();
    n = {
    ...
    $.ajax({
        ...
        success: function(n) {
            UnBlok();
            n.isSuccess && n.data == "OK" ? ShowSuccessMessage(n.statusMessage) : (UnBlok(),
            ShowErrorMessage(n.statusMessage))
        }
    })
}
function ForgotPasswordMobil() {
    validateEmail($("#forgottenEmail").val()) ? ($("#forgottenButton").attr("disabled", "disabled"),
    $.blockUI({
        css: {
            border: "none",
            padding: "15px",
    ...
    $.ajax({
        ...
        data: {
            ...
            OrganizationType: "Budo"
        },
        success: function(n) {
            n.isSuccess ? ($.unblockUI(),
            ShowSuccessMessage(n.statusMessage),
            $("#forgottenButton").removeAttr("disabled")) : ($.unblockUI(),
            ShowErrorMessage(n.statusMessage),
...
function setCookie(n, t, i) {
    var r = new Date, u;
    r.setTime(r.getTime() + parseInt(i) * 6e4);
...
function checkCookie(n, t) {
    var i = getCookie(n)
      , r = new Date
      , u = parseInt(i) + parseInt(t) * 6e4;
    return u - r.getTime() > 0 ? 1 : 0
}
function checkCookie1(n) {
    var t = getCookie(n);
    return t != "" ? 1 : 0
}
function extendTime(n, t) {
    var i, r;
    if (clearTimeout(myVar),
    countdown = fcountdown,
    sn = 00,
    checkCookie1("tryCount") == 0 || parseInt(getCookie("tryCount")) == 0)
        setCookie("tryCount", 1, 240);
    else {
        if (i = parseInt(getCookie("tryCount")),
        i = i + 1,
        parseInt(i) > processcount)
            return setCookie("tryCount", 0, 240),
            alert(extendTime1 + " " + processcount + " " + extendTime2),
            window.location.href = "/",
            !1;
        setCookie("tryCount", i, 240)
    }
    r = new Date;
    setCookie("sTime", r.getTime(), t);
    $.ajax({
        type: "POST",
        url: "/" + lang + "/Bus/SepetUzat",
        data: {
            SessionId: n
        },
        success: function(n) {
            if (n.isSuccess) {
                alert(sessionAdd1 + " " + t + " " + sessionAdd2);
                var i = null;
                i = setInterval(function() {
                    checkCookie("sTime", extendTimee) == 1 || (parseInt(getCookie("tryCount")) + 1 == processcount && $("#errorMessageBox").html(atMaximum),
                    parseInt(getCookie("tryCount")) + 1 > processcount && ($("#extendtimeee").hide(),
                    $("#errorMessageBox").html(greaterThanMaximum),
                    $("#dakika").hide(),
                    $("#saniye").hide(),
                    endProcessSon()),
                    parseInt(getCookie("tryCount")) + 1 < processcount && beginToCountDown(),
                    $("#extendTime").modal("show"),
                    clearInterval(i))
                }, 1e3)
            } else
                alert(problemRedirect),
                window.location.href = "/"
        }
    })
}
function beginToCountDown() {
    myVar = setTimeout("beginToCountDown()", 1e3);
    sn--;
    sn == -1 && (sn = 59,
    countdown--);
    dakika.innerHTML = "0" + countdown + ":";
    saniye.innerHTML = sn + "";
    countdown <= 0 && sn <= 0 && (endProcess(),
...
function endProcess() {
    ...
    $.ajax({
        type: "POST",
        url: "/" + lang + "/Bus/DeleteSepet?sessionId=" + sessionData,
        contentType: "application/json; charset=utf-8",
        datatype: "json",
        "async": !1,
        success: function(n) {
            n ? (setCookie("tryCount", 0, 240),
            window.location.href = "/") : (setCookie("tryCount", 0, 240),
            alert(problemRedirect),
            window.location.href = "/")
        }
    })
}
function endProcessSon() {
    console.log(sessionData);
    $.ajax({
        type: "POST",
        url: "/" + lang + "/Bus/DeleteSepet?sessionId=" + sessionData,
        ...
        "async": !1,
        success: function(n) {
            n ? setCookie("tryCount", 0, 240) : setCookie("tryCount", 0, 240)
        }
    })
}
var blockUICss, sn;
...
!function(n, t) {
    ...
    function r(n) {
        for (var i, t = 1; t < arguments.length; t++)
            ...
            t % 2 ? ci(Object(i), !0).forEach(function(t) {
                yr(n, t, i[t])
            }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(n, Object.getOwnPropertyDescriptors(i)) : ci(Object(i)).forEach(function(t) {
    ...
    function ot(n) {
        ...
        var t = h(n)
          ...
          , r = t.overflowX
          , u = t.overflowY;
        return /(auto|scroll|overlay)/.test(i + u + r) ? n : ot(kt(n))
    }
    function yi(n) {
        return n && n.referenceNode ? n.referenceNode : n
    }
    function k(n) {
        return 11 === n ? dt : 10 === n ? gt : dt || gt
    }
    function d(n) {
        var r, t, i;
        if (!n)
            return document.documentElement;
        for (r = k(10) ? document.body : null,
        t = n.offsetParent || null; t === r && n.nextElementSibling; )
            t = (n = n.nextElementSibling).offsetParent;
        return i = t && t.nodeName,
        i && "BODY" !== i && "HTML" !== i ? -1 !== ["TH", "TD", "TABLE"].indexOf(t.nodeName) && "static" === h(t, "position") ? d(t) : t : n ? n.ownerDocument.documentElement : document.documentElement
    }
    function ni(n) {
        return null !== n.parentNode ? ni(n.parentNode) : n
    }
    function lt(n, t) {
        var u, h, i, f;
        ...
        n !== i && t !== i || o.contains(s)) ? "BODY" === (h = (u = i).nodeName) || "HTML" !== h && d(u.firstElementChild) !== u ? d(i) : i : (f = ni(n),
        f.host ? lt(f.host, t) : lt(n, ni(t).host))
    }
    function g(n) {
        var f = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "top", t = "top" === f ? "scrollTop" : "scrollLeft", i = n.nodeName, r, u;
    ...
    function wi(n, t, i, r) {
        return Math.max(t["offset" + n], t["scroll" + n], i["client" + n], i["offset" + n], i["scroll" + n], k(10) ? parseInt(i["offset" + n]) + parseInt(r["margin" + ("Height" === n ? "Top" : "Left")]) + parseInt(r["margin" + ("Height" === n ? "Bottom" : "Right")]) : 0)
    }
    function bi(n) {
        var i = n.body
          , t = n.documentElement
          , r = k(10) && getComputedStyle(t);
        return {
            height: wi("Height", i, t, r),
            width: wi("Width", i, t, r)
        }
    }
    function e(n) {
        return u({}, n, {
    ...
    function ti(n) {
        var t = {}, r, u, s;
        try {
            k(10) ? (t = n.getBoundingClientRect(),
            r = g(n, "top"),
            u = g(n, "left"),
            t.top += r,
            t.left += u,
        ...
        var i = {
          ...
          , c = "HTML" === n.nodeName ? bi(n.ownerDocument) : {}
          , l = c.width || n.clientWidth || i.width
          , a = c.height || n.clientHeight || i.height
          , f = n.offsetWidth - l
          , o = n.offsetHeight - a;
        return (f || o) && (s = h(n),
        f -= pi(s, "x"),
    ...
    function ii(n, t) {
        var v = arguments.length > 2 && void 0 !== arguments[2] && arguments[2], y = k(10), p = "HTML" === t.nodeName, u = ti(n), r = ti(t), c = ot(n), f = h(t), l = parseFloat(f.borderTopWidth, 10), a = parseFloat(f.borderLeftWidth, 10), i, o, s;
        return v && p && (r.top = Math.max(r.top, 0),
        ...
        (i.marginTop = 0,
        i.marginLeft = 0,
        !y && p) && (o = parseFloat(f.marginTop, 10),
        s = parseFloat(f.marginLeft, 10),
        i.top -= l - o,
        i.bottom -= l - o,
        i.left -= a - s,
        i.right -= a - s,
        i.marginTop = o,
        i.marginLeft = s),
        (y && !v ? t.contains(c) : t === c && "BODY" !== c.nodeName) && (i = ru(i, t)),
        i
    }
    function eu(n) {
    ...
    function ki(n) {
        var i = n.nodeName, t;
        return "BODY" === i || "HTML" === i ? !1 : "fixed" === h(n, "position") ? !0 : (t = kt(n),
        !!t && ki(t))
    }
    function di(n) {
        if (!n || !n.parentElement || k())
            return document.documentElement;
        for (var t = n.parentElement; t && "none" === h(t, "transform"); )
            t = t.parentElement;
        return t || document.documentElement
    }
    function ri(n, t, i, r) {
        var s = arguments.length > 4 && void 0 !== arguments[4] && arguments[4], u = {
            top: 0,
            left: 0
        }, h = s ? di(n) : lt(n, yi(t)), e, f, o;
        if ("viewport" === r)
            u = eu(h, s);
        else if (e = void 0,
        "scrollParent" === r ? "BODY" === (e = ot(kt(t))).nodeName && (e = n.ownerDocument.documentElement) : e = "window" === r ? n.ownerDocument.documentElement : r,
        f = ii(e, h, s),
        "HTML" !== e.nodeName || ki(h))
            u = f;
        else {
            var c = bi(n.ownerDocument)
              , l = c.height
              , a = c.width;
    ...
    function rr(n, t, i) {
        return (void 0 === i ? n : n.slice(0, function(n, t, i) {
            ...
            n.enabled && vi(i) && (t.offsets.popper = e(t.offsets.popper),
    ...
    function hu() {
        ...
        ur(this.modifiers, "applyStyle") && (this.popper.removeAttribute("x-placement"),
        ...
        this.popper.style[ui("transform")] = ""),
    ...
    function cu(n, t, i, r) {
        i.updateBound = r;
        fr(n).addEventListener("resize", i.updateBound, {
            passive: !0
        });
        var u = ot(n);
    ...
    function au() {
        ...
        n = this.state,
        fr(t).removeEventListener("resize", n.updateBound),
    ...
    function ei(n, t) {
        Object.keys(t).forEach(function(i) {
            var r = "";
            -1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(i) && fi(t[i]) && (r = "px");
            n.style[i] = t[i] + r
        })
    }
    function or(n, t, i) {
        var u = st(n, function(n) {
            return n.name === t
        ...
        (s = s.map(function(n, r) {
            ...
            return n.reduce(function(n, t) {
                ...
                return function(n, t, i, r) {
                    var s = n.match(/((?:\-|\+)?\d*\.?\d*)(.*)/), f = +s[1], u = s[2], o;
                    if (!f)
                        return n;
                    if (0 === u.indexOf("%")) {
                        o = void 0;
        ...
        for (var u = (new window.DOMParser).parseFromString(n, "text/html"), e = Object.keys(t), f = [].slice.call(u.body.querySelectorAll("*")), o = function(n) {
            ...
            r.forEach(function(n) {
                (function(n, t) {
                    ...
                    if (-1 !== t.indexOf(i))
                        return -1 === rf.indexOf(i) || Boolean(n.nodeValue.match(uf) || n.nodeValue.match(ff));
    ...
    var i, li, y, dt, gt, er, oi, vt, hr, o, ar, rt;
        ...
        typeCheckConfig: function(n, t, r) {
            ...
            for (u in r)
                if (Object.prototype.hasOwnProperty.call(r, u)) {
                    var o = r[u]
                      , e = t[u]
                      , s = e && i.isElement(e) ? "element" : null === (f = e) || "undefined" == typeof f ? "" + f : {}.toString.call(f).match(/\s([a-z]+)/i)[1].toLowerCase();
    ...
    var ut = "alert"
      ...
      , v = function() {
        ...
        r._removeElement = function(n) {
            ...
            t(n).hasClass("fade")) ? (r = i.getTransitionDurationFromElement(n),
        ...
        r._destroyElement = function(n) {
            t(n).detach().trigger("closed.bs.alert").remove()
        }
        ,
    ...
    t(document).on("click.bs.alert.data-api", '[data-dismiss="alert"]', v._handleDismiss(new v));
    ...
    y = function() {
        ...
        return i.toggle = function() {
            var i = !0, u = !0, f = t(this._element).closest('[data-toggle="buttons"]')[0], n, r;
            f && (n = this._element.querySelector('input:not([type="hidden"])'),
            n && ("radio" === n.type && (n.checked && this._element.classList.contains("active") ? i = !1 : (r = f.querySelector(".active"),
            r && t(r).removeClass("active"))),
            i && ("checkbox" !== n.type && "radio" !== n.type || (n.checked = !this._element.classList.contains("active")),
            t(n).trigger("change")),
            n.focus(),
            u = !1));
            ...
            i && t(this._element).toggleClass("active"))
        }
        ,
        i.dispose = function() {
    ...
    t(document).on("click.bs.button.data-api", '[data-toggle^="button"]', function(n) {
        var i = n.target, u = i, r;
        if (t(i).hasClass("btn") || (i = t(i).closest(".btn")[0]),
        !i || i.hasAttribute("disabled") || i.classList.contains("disabled"))
            n.preventDefault();
        else {
            if (r = i.querySelector('input:not([type="hidden"])'),
            r && (r.hasAttribute("disabled") || r.classList.contains("disabled")))
                return void n.preventDefault();
            "LABEL" === u.tagName && r && "checkbox" === r.type && n.preventDefault();
            y._jQueryInterface.call(t(i), "toggle")
        }
    }).on("focus.bs.button.data-api blur.bs.button.data-api", '[data-toggle^="button"]', function(n) {
        var i = t(n.target).closest(".btn")[0];
        t(i).toggleClass("focus", /^focus(in)?$/.test(n.type))
    });
    ...
    var p = "carousel"
      ...
      , w = function() {
        ...
        n.pause = function(n) {
            n || (this._isPaused = !0);
            this._element.querySelector(".carousel-item-next, .carousel-item-prev") && (i.triggerTransitionEnd(this._element),
            this.cycle(!0));
        ...
        n._addTouchEventListeners = function() {
            ...
            ,
            t(this._element.querySelectorAll(".carousel-item img")).on("dragstart.bs.carousel", function(n) {
                return n.preventDefault()
            }),
            this._pointerEvent ? (t(this._element).on("pointerdown.bs.carousel", function(n) {
                return i(n)
            }),
            t(this._element).on("pointerup.bs.carousel", function(n) {
                return r(n)
            }),
            this._element.classList.add("pointer-event")) : (t(this._element).on("touchstart.bs.carousel", function(n) {
                return i(n)
            }),
            ...
            t(this._element).on("touchend.bs.carousel", function(n) {
                return r(n)
            })))
        }
        ,
        ...
        n._setActiveIndicatorElement = function(n) {
            var r, i;
            this._indicatorsElement && (r = [].slice.call(this._indicatorsElement.querySelectorAll(".active")),
        ...
        n._slide = function(n, r) {
            var e, o, s, l = this, f = this._element.querySelector(".active.carousel-item"), y = this._getItemIndex(f), u = r || f && this._getItemByDirection(n, f), p = this._getItemIndex(u), a = Boolean(this._interval), h, c, v;
            ("next" === n ? (e = "carousel-item-left",
            o = "carousel-item-next",
            s = "left") : (e = "carousel-item-right",
            o = "carousel-item-prev",
            s = "right"),
            u && t(u).hasClass("active")) ? this._isSliding = !1 : !this._triggerSlideEvent(u, s).isDefaultPrevented() && f && u && (this._isSliding = !0,
            a && this.pause(),
            this._setActiveIndicatorElement(u),
            h = t.Event("slid.bs.carousel", {
                relatedTarget: u,
                direction: s,
                from: y,
                to: p
            }),
            t(this._element).hasClass("slide") ? (t(u).addClass(o),
            i.reflow(u),
            t(f).addClass(e),
            t(u).addClass(e),
            c = parseInt(u.getAttribute("data-interval"), 10),
            c ? (this._config.defaultInterval = this._config.defaultInterval || this._config.interval,
            this._config.interval = c) : this._config.interval = this._config.defaultInterval || this._config.interval,
            v = i.getTransitionDurationFromElement(f),
            t(f).one(i.TRANSITION_END, function() {
                t(u).removeClass(e + " " + o).addClass("active");
                t(f).removeClass("active " + o + " " + e);
                l._isSliding = !1;
                setTimeout(function() {
                    return t(l._element).trigger(h)
                }, 0)
            }).emulateTransitionEnd(v)) : (t(f).removeClass("active"),
            t(u).addClass("active"),
            this._isSliding = !1,
        ...
        u._jQueryInterface = function(n) {
            return this.each(function() {
                var i = t(this).data("bs.carousel"), f = r(r({}, wt), t(this).data()), e;
                if ("object" == typeof n && (f = r(r({}, f), n)),
        ...
        ,
        u._dataApiClickHandler = function(n) {
            var s = i.getSelectorFromElement(this), f, o, e;
            s && (f = t(s)[0],
            f && t(f).hasClass("carousel") && (o = r(r({}, t(f).data()), t(this).data()),
            e = this.getAttribute("data-slide-to"),
            e && (o.interval = !1),
            u._jQueryInterface.call(t(f), o),
            e && t(f).data("bs.carousel").to(e),
            n.preventDefault()))
        }
        ,
        f(u, null, [{
    ...
    t(document).on("click.bs.carousel.data-api", "[data-slide], [data-slide-to]", w._dataApiClickHandler);
    t(window).on("load.bs.carousel.data-api", function() {
        for (var i, r = [].slice.call(document.querySelectorAll('[data-ride="carousel"]')), n = 0, u = r.length; n < u; n++)
            i = t(r[n]),
    ...
    var b = "collapse"
      ...
      , ft = function() {
        function u(n, t) {
            ...
            for (var f = [].slice.call(document.querySelectorAll('[data-toggle="collapse"]')), r = 0, o = f.length; r < o; r++) {
                var e = f[r]
                  , u = i.getSelectorFromElement(e)
                  , s = [].slice.call(document.querySelectorAll(u)).filter(function(t) {
                    return t === n
                });
                null !== u && s.length > 0 && (this._selector = u,
        ...
        ,
        n.show = function() {
            var n, e, r = this, o, f, s, h;
            this._isTransitioning || t(this._element).hasClass("show") || (this._parent && 0 === (n = [].slice.call(this._parent.querySelectorAll(".show, .collapsing")).filter(function(n) {
                return "string" == typeof r._config.parent ? n.getAttribute("data-parent") === r._config.parent : n.classList.contains("collapse")
            })).length && (n = null),
            n && (e = t(n).not(this._selector).data("bs.collapse")) && e._isTransitioning) || (o = t.Event("show.bs.collapse"),
            (t(this._element).trigger(o),
            o.isDefaultPrevented()) || (n && (u._jQueryInterface.call(t(n).not(this._selector), "hide"),
            e || t(n).data("bs.collapse", null)),
        ...
        n.hide = function() {
            ...
            if (!this._isTransitioning && t(this._element).hasClass("show") && (u = t.Event("hide.bs.collapse"),
            ...
            !u.isDefaultPrevented())) {
                ...
                f > 0)
                    for (r = 0; r < f; r++)
                        ...
                        null !== o && (t([].slice.call(document.querySelectorAll(o))).hasClass("show") || t(e).addClass("collapsed").attr("aria-expanded", !1));
                this.setTransitioning(!0);
                this._element.style[n] = "";
                h = i.getTransitionDurationFromElement(this._element);
                t(this._element).one(i.TRANSITION_END, function() {
                    s.setTransitioning(!1);
                    t(s._element).removeClass("collapsing").addClass("collapse").trigger("hidden.bs.collapse")
                }).emulateTransitionEnd(h)
            }
        }
        ,
        ...
        ,
        n._getConfig = function(n) {
            return (n = r(r({}, bt), n)).toggle = Boolean(n.toggle),
            i.typeCheckConfig(b, n, nu),
            n
        }
        ,
        ...
        n._getParent = function() {
            ...
            f = [].slice.call(n.querySelectorAll(r)),
            t(f).each(function(n, t) {
                e._addAriaAndCollapsedClass(u._getTargetFromElement(t), [t])
            }),
            n
        }
        ,
        n._addAriaAndCollapsedClass = function(n, i) {
            var r = t(n).hasClass("show");
            i.length && t(i).toggleClass("collapsed", !r).attr("aria-expanded", r)
        }
        ,
        u._getTargetFromElement = function(n) {
        ...
        u._jQueryInterface = function(n) {
            return this.each(function() {
                var f = t(this)
                  , i = f.data("bs.collapse")
                  , e = r(r(r({}, bt), f.data()), "object" == typeof n && n ? n : {});
                if (!i && e.toggle && "string" == typeof n && /show|hide/.test(n) && (e.toggle = !1),
                i || (i = new u(this,e),
                f.data("bs.collapse", i)),
                "string" == typeof n) {
    ...
    t(document).on("click.bs.collapse.data-api", '[data-toggle="collapse"]', function(n) {
        ...
        t(f).each(function() {
            var n = t(this)
              , i = n.data("bs.collapse") ? "toggle" : r.data();
            ft._jQueryInterface.call(n, i)
        })
    });
    t.fn[b] = ft._jQueryInterface;
    t.fn[b].Constructor = ft;
    t.fn[b].noConflict = function() {
        return t.fn[b] = gr,
        ft._jQueryInterface
    }
    ;
    var et = "undefined" != typeof window && "undefined" != typeof document && "undefined" != typeof navigator
      , tu = function() {
        for (var t = ["Edge", "Trident", "Firefox"], n = 0; n < t.length; n += 1)
            if (et && navigator.userAgent.indexOf(t[n]) >= 0)
                return 1;
        return 0
    }()
      , iu = et && window.Promise ? function(n) {
        var t = !1;
        return function() {
            t || (t = !0,
    ...
    ;
    dt = et && !(!window.MSInputMethodContext || !document.documentMode);
    gt = et && /MSIE 10/.test(navigator.userAgent);
    var uu = function(n, t) {
        if (!(n instanceof t))
    ...
    ;
    er = et && /Firefox/i.test(navigator.userAgent);
    oi = ["auto-start", "auto", "auto-end", "top-start", "top", "top-end", "right-start", "right", "right-end", "bottom-end", "bottom", "bottom-start", "left-end", "left", "left-start"];
    vt = oi.slice(3);
    var vu = "flip"
      , yu = "clockwise"
      , pu = "counterclockwise";
    hr = {
        ...
        modifiers: {
                ...
                fn: function(n) {
                    ...
                    if (f) {
                        var e = n.offsets
                          ...
                          , l = {
                            start: nt({}, t, i[t]),
                            end: nt({}, t, i[t] + i[h] - o[h])
                        };
                        n.offsets.popper = u({}, o, l[f])
                    }
                    return n
                }
            },
            ...
            preventOverflow: {
                ...
                enabled: !0,
                fn: function(n, t) {
                    var e = t.boundariesElement || d(n.instance.popper), f;
                    n.instance.reference === e && (e = d(e));
                    var o = ui("transform")
                    ...
                    r.left = "";
                    r[o] = "";
                    f = ri(n.instance.popper, n.instance.reference, t.padding, e, n.positionFixed);
                    r.top = s;
                    r.left = h;
                    r[o] = c;
                    t.boundaries = f;
                    var l = t.priority
                      ...
                      , a = {
                        primary: function(n) {
                            var r = i[n];
                            return i[n] < f[n] && !t.escapeWithReference && (r = Math.max(i[n], f[n])),
                            nt({}, n, r)
                        },
                        secondary: function(n) {
                            var r = "right" === n ? "left" : "top"
                              , u = i[r];
                            return i[n] > f[n] && !t.escapeWithReference && (u = Math.min(i[r], f[n] - ("right" === n ? i.width : i.height))),
                            nt({}, r, u)
                        }
                    };
            ...
            arrow: {
                ...
                fn: function(n, t) {
                    var l, r;
                    if (!or(n.instance.modifiers, "arrow", "keepTogether"))
                        return n;
                    if (r = t.element,
                    "string" == typeof r) {
                    ...
                    var b = n.placement.split("-")[0]
                      ...
                      , c = s ? "bottom" : "right"
                      , f = tr(r)[a];
                    u[c] - f < o[i] && (n.offsets.popper[i] -= o[i] - (u[c] - f));
                    u[i] + f > o[c] && (n.offsets.popper[i] += u[i] + f - o[c]);
                    n.offsets.popper = e(n.offsets.popper);
                    var d = u[i] + u[a] / 2 - f / 2
                      , w = h(n.instance.popper)
                      , g = parseFloat(w["margin" + v], 10)
                      , tt = parseFloat(w["border" + v + "Width"], 10)
                      , y = d - n.offsets.popper[i] - g - tt;
                    return y = Math.max(Math.min(o[a] - f, y), 0),
                    n.arrowElement = r,
                    n.offsets.arrow = (nt(l = {}, i, Math.round(y)),
                    nt(l, k, ""),
                    l),
                    n
                },
            ...
            flip: {
                ...
                enabled: !0,
                fn: function(n, t) {
                    if (ur(n.instance.modifiers, "inner") || n.flipped && n.placement === n.originalPlacement)
                        return n;
                    var e = ri(n.instance.popper, n.instance.reference, t.padding, t.boundariesElement, n.positionFixed)
                    ...
                    return f.forEach(function(s, h) {
                        ...
                        n.placement = i + (r ? "-" + r : ""),
                        n.offsets.popper = u({}, n.offsets.popper, ir(n.instance.popper, n.offsets.reference, n.placement)),
                        n = rr(n.instance.modifiers, n, "flip"))
                    }),
                    n
                },
                behavior: "flip",
            ...
            inner: {
                ...
                fn: function(n) {
                    ...
                    return i[f ? "left" : "top"] = o[t] - (s ? i[f ? "width" : "height"] : 0),
                    n.placement = at(r),
                    n.offsets.popper = e(i),
                    n
                }
            },
            hide: {
                ...
                enabled: !0,
                fn: function(n) {
                    if (!or(n.instance.modifiers, "hide", "preventOverflow"))
                        return n;
                    var t = n.offsets.reference
                      , i = st(n.instance.modifiers, function(n) {
            ...
            computeStyle: {
                ...
                enabled: !0,
                fn: function(n, t) {
                    var w = t.x, b = t.y, k = n.offsets.popper, s = st(n.instance.modifiers, function(n) {
                        return "applyStyle" === n.name
                    }).gpuAcceleration, v, y, p;
                    void 0 !== s && console.warn("WARNING: `gpuAcceleration` option moved to `computeStyle` modifier and will not be supported in future versions of Popper.js!");
                    var g = void 0 !== s ? s : t.gpuAcceleration
                      , f = d(n.instance.popper)
                      , l = ti(f)
                      , i = {
                        position: k.position
                    }
                    ...
                    }(n, window.devicePixelRatio < 2 || !er)
                      , e = "bottom" === w ? "top" : "bottom"
                      , o = "right" === b ? "left" : "right"
                      , a = ui("transform")
                      , h = void 0
                      , c = void 0;
                    return (c = "bottom" === e ? "HTML" === f.nodeName ? -f.clientHeight + r.bottom : -l.height + r.bottom : r.top,
                    h = "right" === o ? "HTML" === f.nodeName ? -f.clientWidth + r.right : -l.width + r.right : r.left,
                    g && a) ? (i[a] = "translate3d(" + h + "px, " + c + "px, 0)",
                    i[e] = 0,
                    i[o] = 0,
                    i.willChange = "transform") : (v = "bottom" === e ? -1 : 1,
                    y = "right" === o ? -1 : 1,
                    i[e] = c * v,
                    i[o] = h * y,
                    i.willChange = e + ", " + o),
                    ...
                    n.attributes = u({}, p, n.attributes),
                    n.styles = u({}, i, n.styles),
                    n.arrowStyles = u({}, n.offsets.arrow, n.arrowStyles),
                    n
                },
                gpuAcceleration: !0,
                x: "bottom",
            ...
            applyStyle: {
                ...
                fn: function(n) {
                    var i, t;
                    return ei(n.instance.popper, n.styles),
                    i = n.instance.popper,
                    t = n.attributes,
                    Object.keys(t).forEach(function(n) {
                        !1 !== t[n] ? i.setAttribute(n, t[n]) : i.removeAttribute(n)
                    }),
                    n.arrowElement && Object.keys(n.arrowStyles).length && ei(n.arrowElement, n.arrowStyles),
                    n
                },
    ...
    o = function() {
        function n(t, i) {
            var r = this, f = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}, e;
            uu(this, n);
            ...
            Object.keys(u({}, n.Defaults.modifiers, f.modifiers)).forEach(function(t) {
                r.options.modifiers[t] = u({}, n.Defaults.modifiers[t] || {}, f.modifiers ? f.modifiers[t] : {})
            });
    ...
    var tt = "dropdown"
      ...
      , s = function() {
            ...
            !(this._element.disabled || t(this._element).hasClass("disabled") || t(this._menu).hasClass("show"))) {
                ...
                !s.isDefaultPrevented()) {
                    if (!this._inNavbar && r) {
                        ...
                        "scrollParent" !== this._config.boundary && t(u).addClass("position-static");
                        this._popper = new o(f,this._menu,this._getPopperConfig())
                    }
                    "ontouchstart"in document.documentElement && 0 === t(u).closest(".navbar-nav").length && t(document.body).children().on("mouseover", null, t.noop);
                    this._element.focus();
                    this._element.setAttribute("aria-expanded", !0);
                    t(this._menu).toggleClass("show");
                    t(u).toggleClass("show").trigger(t.Event("shown.bs.dropdown", e))
                }
            }
        }
        ,
        u.hide = function() {
            if (!this._element.disabled && !t(this._element).hasClass("disabled") && t(this._menu).hasClass("show")) {
                var i = {
                  ...
                  , r = t.Event("hide.bs.dropdown", i)
                  , u = n._getParentFromElement(this._element);
                t(u).trigger(r);
                r.isDefaultPrevented() || (this._popper && this._popper.destroy(),
                t(this._menu).toggleClass("show"),
                t(u).toggleClass("show").trigger(t.Event("hidden.bs.dropdown", i)))
            }
        }
        ,
        u.dispose = function() {
        ...
        u._getConfig = function(n) {
            return n = r(r(r({}, this.constructor.Default), t(this._element).data()), n),
        ...
        u._getPlacement = function() {
            var i = t(this._element.parentNode)
              , n = "bottom-start";
            return i.hasClass("dropup") ? n = t(this._menu).hasClass("dropdown-menu-right") ? "top-end" : "top-start" : i.hasClass("dropright") ? n = "right-start" : i.hasClass("dropleft") ? n = "left-start" : t(this._menu).hasClass("dropdown-menu-right") && (n = "bottom-end"),
            n
        }
        ,
        ...
        u._getOffset = function() {
            ...
            return "function" == typeof this._config.offset ? n.fn = function(n) {
                return n.offsets = r(r({}, n.offsets), t._config.offset(n.offsets, t._element) || {}),
                n
            }
        ...
        u._getPopperConfig = function() {
            ...
            r(r({}, n), this._config.popperConfig)
        }
        ,
        n._jQueryInterface = function(i) {
            return this.each(function() {
        ...
        n._clearMenus = function(i) {
            ...
            if (!i || 3 !== i.which && ("keyup" !== i.type || 9 === i.which))
                for (var u = [].slice.call(document.querySelectorAll('[data-toggle="dropdown"]')), r = 0, c = u.length; r < c; r++) {
                    var f = n._getParentFromElement(u[r])
                      , e = t(u[r]).data("bs.dropdown")
                      , o = {
                        relatedTarget: u[r]
                    };
                    (i && "click" === i.type && (o.clickEvent = i),
                    e) && (h = e._menu,
                    !t(f).hasClass("show") || i && ("click" === i.type && /input|textarea/i.test(i.target.tagName) || "keyup" === i.type && 9 === i.which) && t.contains(f, i.target) || (s = t.Event("hide.bs.dropdown", o),
                    t(f).trigger(s),
                    s.isDefaultPrevented() || ("ontouchstart"in document.documentElement && t(document.body).children().off("mouseover", null, t.noop),
                    u[r].setAttribute("aria-expanded", "false"),
                    e._popper && e._popper.destroy(),
                    t(h).removeClass("show"),
                    t(f).removeClass("show").trigger(t.Event("hidden.bs.dropdown", o)))))
                }
        }
        ,
        ...
        n._dataApiKeydownHandler = function(i) {
            var f, e, u, r;
            if (!(/input|textarea/i.test(i.target.tagName) ? 32 === i.which || 27 !== i.which && (40 !== i.which && 38 !== i.which || t(i.target).closest(".dropdown-menu").length) : !ku.test(i.which)) && !this.disabled && !t(this).hasClass("disabled") && (f = n._getParentFromElement(this),
            e = t(f).hasClass("show"),
            e || 27 !== i.which)) {
                if (i.preventDefault(),
                i.stopPropagation(),
                !e || e && (27 === i.which || 32 === i.which))
                    return 27 === i.which && t(f.querySelector('[data-toggle="dropdown"]')).trigger("focus"),
    ...
    t(document).on("keydown.bs.dropdown.data-api", '[data-toggle="dropdown"]', s._dataApiKeydownHandler).on("keydown.bs.dropdown.data-api", ".dropdown-menu", s._dataApiKeydownHandler).on("click.bs.dropdown.data-api keyup.bs.dropdown.data-api", s._clearMenus).on("click.bs.dropdown.data-api", '[data-toggle="dropdown"]', function(n) {
        n.preventDefault();
        n.stopPropagation();
        s._jQueryInterface.call(t(this), "toggle")
    }).on("click.bs.dropdown.data-api", ".dropdown form", function(n) {
        n.stopPropagation()
    });
    t.fn[tt] = s._jQueryInterface;
    t.fn[tt].Constructor = s;
    ...
    var nf = t.fn.modal
      ...
      , ht = function() {
        ...
        n.show = function(n) {
            var i = this, r;
            this._isShown || this._isTransitioning || (t(this._element).hasClass("fade") && (this._isTransitioning = !0),
            ...
            t(this._element).on("click.dismiss.bs.modal", '[data-dismiss="modal"]', function(n) {
                return i.hide(n)
            }),
            t(this._dialog).on("mousedown.dismiss.bs.modal", function() {
                t(i._element).one("mouseup.dismiss.bs.modal", function(n) {
        ...
        n.hide = function(n) {
            var e = this, r, u, f;
            (n && n.preventDefault(),
            this._isShown && !this._isTransitioning) && (r = t.Event("hide.bs.modal"),
            (t(this._element).trigger(r),
            this._isShown && !r.isDefaultPrevented()) && (this._isShown = !1,
            u = t(this._element).hasClass("fade"),
            ...
            u) ? (f = i.getTransitionDurationFromElement(this._element),
        ...
        n._triggerBackdropTransition = function() {
            ...
            if ("static" === this._config.backdrop) {
                if (n = t.Event("hidePrevented.bs.modal"),
                t(this._element).trigger(n),
                n.defaultPrevented)
                    return;
                this._element.classList.add("modal-static");
                r = i.getTransitionDurationFromElement(this._element);
                t(this._element).one(i.TRANSITION_END, function() {
                    u._element.classList.remove("modal-static")
        ...
        n._showElement = function(n) {
            var r = this, f = t(this._element).hasClass("fade"), e = this._dialog ? this._dialog.querySelector(".modal-body") : null, o, u, s;
            this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element);
            this._element.style.display = "block";
            this._element.removeAttribute("aria-hidden");
            this._element.setAttribute("aria-modal", !0);
            t(this._dialog).hasClass("modal-dialog-scrollable") && e ? e.scrollTop = 0 : this._element.scrollTop = 0;
            ...
            u = function() {
                ...
                t(r._element).trigger(o)
            }
            ;
            f ? (s = i.getTransitionDurationFromElement(this._dialog),
            t(this._dialog).one(i.TRANSITION_END, u).emulateTransitionEnd(s)) : u()
        }
        ,
        ...
        n._hideModal = function() {
            ...
            this._showBackdrop(function() {
                ...
                n._resetAdjustments();
                n._resetScrollbar();
                t(n._element).trigger("hidden.bs.modal")
            })
        }
        ,
        ...
        n._showBackdrop = function(n) {
            var r = this, u = t(this._element).hasClass("fade") ? "fade" : "", e, f, o;
            if (this._isShown && this._config.backdrop) {
                if (this._backdrop = document.createElement("div"),
                this._backdrop.className = "modal-backdrop",
                u && this._backdrop.classList.add(u),
                t(this._backdrop).appendTo(document.body),
                t(this._element).on("click.dismiss.bs.modal", function(n) {
                    r._ignoreBackdropClick ? r._ignoreBackdropClick = !1 : n.target === n.currentTarget && r._triggerBackdropTransition()
                }),
                u && i.reflow(this._backdrop),
                t(this._backdrop).addClass("show"),
                !n)
                    return;
                if (!u)
                    return void n();
                e = i.getTransitionDurationFromElement(this._backdrop);
                t(this._backdrop).one(i.TRANSITION_END, n).emulateTransitionEnd(e)
            } else
                !this._isShown && this._backdrop ? (t(this._backdrop).removeClass("show"),
                f = function() {
                    r._removeBackdrop();
                    n && n()
                }
                ,
                t(this._element).hasClass("fade") ? (o = i.getTransitionDurationFromElement(this._backdrop),
                t(this._backdrop).one(i.TRANSITION_END, f).emulateTransitionEnd(o)) : f()) : n && n()
        }
        ,
        ...
        n._setScrollbar = function() {
            var n = this, i, r, u, f;
            this._isBodyOverflowing && (i = [].slice.call(document.querySelectorAll(".fixed-top, .fixed-bottom, .is-fixed, .sticky-top")),
        ...
        n._resetScrollbar = function() {
            var r = [].slice.call(document.querySelectorAll(".fixed-top, .fixed-bottom, .is-fixed, .sticky-top")), n, i;
        ...
        u._jQueryInterface = function(n, i) {
            return this.each(function() {
                var f = t(this).data("bs.modal")
                  , e = r(r(r({}, si), t(this).data()), "object" == typeof n && n ? n : {});
                if (f || (f = new u(this,e),
                t(this).data("bs.modal", f)),
                "string" == typeof n) {
                    if ("undefined" == typeof f[n])
                        throw new TypeError('No method named "' + n + '"');
                    f[n](i)
                } else
                    e.show && f.show(i)
    ...
    t(document).on("click.bs.modal.data-api", '[data-toggle="modal"]', function(n) {
        var u, f = this, e = i.getSelectorFromElement(this), o, s;
        e && (u = document.querySelector(e));
        o = t(u).data("bs.modal") ? "toggle" : r(r({}, t(u).data()), t(this).data());
        "A" !== this.tagName && "AREA" !== this.tagName || n.preventDefault();
        s = t(u).one("show.bs.modal", function(n) {
            n.isDefaultPrevented() || s.one("hidden.bs.modal", function() {
                t(f).is(":visible") && f.focus()
            })
        });
        ht._jQueryInterface.call(t(u), o, this)
    });
    t.fn.modal = ht._jQueryInterface;
    t.fn.modal.Constructor = ht;
    t.fn.modal.noConflict = function() {
        return t.fn.modal = nf,
        ht._jQueryInterface
    }
    ;
    ...
    var c = "tooltip"
      , ef = t.fn[c]
      , of = new RegExp("(^|\\s)bs-tooltip\\S+","g")
      , sf = ["sanitize", "whiteList", "sanitizeFn"]
      , hf = {
        animation: "boolean",
        template: "string",
      ...
      , l = function() {
        ...
        ,
        n.show = function() {
            var n = this, u, f, c, r, e, l, s, a, h, v;
            ...
            this.isWithContent() && this._isEnabled) {
                ...
                c = t.contains(null !== f ? f : this.element.ownerDocument.documentElement, this.element),
                u.isDefaultPrevented() || !c)
                    return;
                ...
                l = "function" == typeof this.config.placement ? this.config.placement.call(this, r, this.element) : this.config.placement;
                s = this._getAttachment(l);
                this.addAttachmentClass(s);
                a = this._getContainer();
                t(r).data(this.constructor.DATA_KEY, this);
                t.contains(this.element.ownerDocument.documentElement, this.tip) || t(r).appendTo(a);
                t(this.element).trigger(this.constructor.Event.INSERTED);
                this._popper = new o(this.element,r,this._getPopperConfig(s));
                t(r).addClass("show");
                ...
                h = function() {
                    ...
                    "out" === i && n._leave(null, n)
                }
                ;
                t(this.tip).hasClass("fade") ? (v = i.getTransitionDurationFromElement(this.tip),
                t(this.tip).one(i.TRANSITION_END, h).emulateTransitionEnd(v)) : h()
            }
        }
        ,
        n.hide = function(n) {
            var r = this, u = this.getTipElement(), f = t.Event(this.constructor.Event.HIDE), e = function() {
                "show" !== r._hoverState && u.parentNode && u.parentNode.removeChild(u);
                r._cleanTipClass();
        ...
        n.setContent = function() {
            ...
            this.setElementContent(t(n.querySelectorAll(".tooltip-inner")), this.getTitle());
            t(n).removeClass("fade show")
        }
        ,
        n.setElementContent = function(n, i) {
            "object" != typeof i || !i.nodeType && !i.jquery ? this.config.html ? (this.config.sanitize && (i = cr(i, this.config.whiteList, this.config.sanitizeFn)),
        ...
        n._getOffset = function() {
            ...
            return "function" == typeof this.config.offset ? n.fn = function(n) {
                return n.offsets = r(r({}, n.offsets), t.config.offset(n.offsets, t.element) || {}),
                n
            }
        ...
        n._setListeners = function() {
            ...
            this.config.trigger.split(" ").forEach(function(i) {
                if ("click" === i)
                    ...
                    var r = "hover" === i ? n.constructor.Event.MOUSEENTER : n.constructor.Event.FOCUSIN
                      , u = "hover" === i ? n.constructor.Event.MOUSELEAVE : n.constructor.Event.FOCUSOUT;
        ...
        n._enter = function(n, i) {
            ...
            t(n.currentTarget).data(r, i));
            n && (i._activeTrigger["focusin" === n.type ? "focus" : "hover"] = !0);
            t(i.getTipElement()).hasClass("show") || "show" === i._hoverState ? i._hoverState = "show" : (clearTimeout(i._timeout),
            i._hoverState = "show",
        ...
        n._leave = function(n, i) {
            ...
            (i = i || t(n.currentTarget).data(r)) || (i = new this.constructor(n.currentTarget,this._getDelegateConfig()),
            t(n.currentTarget).data(r, i));
            n && (i._activeTrigger["focusout" === n.type ? "focus" : "hover"] = !1);
        ...
        ,
        n._getConfig = function(n) {
            var u = t(this.element).data();
            return Object.keys(u).forEach(function(n) {
                -1 !== sf.indexOf(n) && delete u[n]
            }),
            "number" == typeof (n = r(r(r({}, this.constructor.Default), u), "object" == typeof n && n ? n : {})).delay && (n.delay = {
                show: n.delay,
                hide: n.delay
            }),
            "number" == typeof n.title && (n.title = n.title.toString()),
            "number" == typeof n.content && (n.content = n.content.toString()),
            i.typeCheckConfig(c, n, this.constructor.DefaultType),
            n.sanitize && (n.template = cr(n.template, n.whiteList, n.sanitizeFn)),
            n
        }
        ,
        ...
        n._fixTransition = function() {
            ...
            null === n.getAttribute("x-placement") && (t(n).removeClass("fade"),
    ...
    t.fn[c] = l._jQueryInterface;
    t.fn[c].Constructor = l;
    ...
    var it = "popover"
      , vf = t.fn[it]
      , yf = new RegExp("(^|\\s)bs-popover\\S+","g")
      , pf = r(r({}, l.Default), {}, {
        placement: "right",
        trigger: "click",
        content: "",
      ...
      , yt = function(n) {
        ...
        i.setContent = function() {
            ...
            this.setElementContent(i.find(".popover-header"), this.getTitle());
            n = this._getContent();
            "function" == typeof n && (n = n.call(this.element));
            this.setElementContent(i.find(".popover-body"), n);
            i.removeClass("fade show")
        }
        ,
    ...
    t.fn[it] = yt._jQueryInterface;
    t.fn[it].Constructor = yt;
    ...
    var a = "scrollspy"
      ...
      , ct = function() {
        function u(n, i) {
            ...
            t(this._scrollElement).on("scroll.bs.scrollspy", function(n) {
                return r._process(n)
            });
            this.refresh();
            this._process()
        ...
        return n.refresh = function() {
            var n = this
              , u = this._scrollElement === this._scrollElement.window ? "offset" : "position"
              , r = "auto" === this._config.method ? u : this._config.method
              , f = "position" === r ? this._getScrollTop() : 0;
            this._offsets = [];
            this._targets = [];
        ...
        ,
        n._getConfig = function(n) {
            if ("string" != typeof (n = r(r({}, lr), "object" == typeof n && n ? n : {})).target && i.isElement(n.target)) {
                var u = t(n.target).attr("id");
                u || (u = i.getUID(a),
                t(n.target).attr("id", u));
                n.target = "#" + u
            }
            return i.typeCheckConfig(a, n, df),
            n
        }
        ,
        ...
        u._jQueryInterface = function(n) {
            return this.each(function() {
                ...
                if (i || (i = new u(this,"object" == typeof n && n),
    ...
    t(window).on("load.bs.scrollspy.data-api", function() {
        for (var r, n = [].slice.call(document.querySelectorAll('[data-spy="scroll"]')), i = n.length; i--; )
            r = t(n[i]),
            ct._jQueryInterface.call(r, r.data())
    });
    t.fn[a] = ct._jQueryInterface;
    t.fn[a].Constructor = ct;
    ...
    rt = function() {
        ...
        return r.show = function() {
            ...
            this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && t(this._element).hasClass("active") || t(this._element).hasClass("disabled") || (r = t(this._element).closest(".nav, .list-group")[0],
            f = i.getSelectorFromElement(this._element),
            r && (c = "UL" === r.nodeName || "OL" === r.nodeName ? "> li > .active" : ".active",
        ...
        r._activate = function(n, r, u) {
            var s = this, f = (!r || "UL" !== r.nodeName && "OL" !== r.nodeName ? t(r).children(".active") : t(r).find("> li > .active"))[0], h = u && f && t(f).hasClass("fade"), e = function() {
                return s._transitionComplete(n, f, u)
            }, o;
            f && h ? (o = i.getTransitionDurationFromElement(f),
            t(f).removeClass("show").one(i.TRANSITION_END, e).emulateTransitionEnd(o)) : e()
        }
        ,
        r._transitionComplete = function(n, r, u) {
            var f, e, o;
            r && (t(r).removeClass("active"),
            f = t(r.parentNode).find("> .dropdown-menu .active")[0],
            f && t(f).removeClass("active"),
            ...
            n.parentNode && t(n.parentNode).hasClass("dropdown-menu")) && (e = t(n).closest(".dropdown")[0],
    ...
    t(document).on("click.bs.tab.data-api", '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', function(n) {
        n.preventDefault();
        rt._jQueryInterface.call(t(this), "show")
    });
    t.fn.tab = rt._jQueryInterface;
    t.fn.tab.Constructor = rt;
    ...
    var gf = t.fn.toast
      ...
      , pt = function() {
        ...
        return n.show = function() {
            var n = this, u = t.Event("show.bs.toast"), r, f;
            (t(this._element).trigger(u),
            u.isDefaultPrevented()) || (this._config.animation && this._element.classList.add("fade"),
            r = function() {
                n._element.classList.remove("showing");
                n._element.classList.add("show");
                t(n._element).trigger("shown.bs.toast");
        ...
        ,
        n._getConfig = function(n) {
            return n = r(r(r({}, vr), t(this._element).data()), "object" == typeof n && n ? n : {}),
            i.typeCheckConfig("toast", n, this.constructor.DefaultType),
            n
        }
        ,
        n._setListeners = function() {
        ...
        n._close = function() {
            var n = this, r = function() {
                ...
                t(n._element).trigger("hidden.bs.toast")
            }, u;
    ...
    t.fn.toast = pt._jQueryInterface;
    t.fn.toast.Constructor = pt;
    t.fn.toast.noConflict = function() {
        return t.fn.toast = gf,
        pt._jQueryInterface
    }
    ;
    n.Alert = v;
...
(function(n) {
    ...
    n.extend(n.fn, {
        ...
        rules: function(t, i) {
            ...
            if (r != null && (!r.form && r.hasAttribute("contenteditable") && (r.form = this.closest("form")[0],
        ...
        prototype: {
            ...
            elements: function() {
                ...
                return n(this.currentForm).find("input, select, textarea, [contenteditable]").not(":submit, :reset, :image, :disabled").not(this.settings.ignore).filter(function() {
                    ...
                    this.name = r),
                    r in i || !t.objectLength(n(this).rules())) ? !1 : (i[r] = !0,
                    !0)
                })
            },
            clean: function(t) {
            ...
            elementValue: function(t) {
                ...
                return u === "radio" || u === "checkbox" ? this.findByName(t.name).filter(":checked").val() : u === "number" && typeof t.validity != "undefined" ? t.validity.badInput ? "NaN" : f.val() : (i = t.hasAttribute("contenteditable") ? f.text() : f.val(),
                u === "file") ? i.substr(0, 12) === "C:\\fakepath\\" ? i.substr(12) : (r = i.lastIndexOf("/"),
            ...
            check: function(t) {
                ...
                var i = n(t).rules(), c = n.map(i, function(n, t) {
                    return t
                }).length, h = !1, u = this.elementValue(t), f, e, r, o;
                if (typeof i.normalizer == "function" ? o = i.normalizer : typeof this.settings.normalizer == "function" && (o = this.settings.normalizer),
                o) {
                    if (u = o.call(t, u),
                    typeof u != "string")
                ...
                for (e in i) {
                    ...
                    try {
                        if (f = n.validator.methods[e].call(this, u, t, r.parameters),
                        f === "dependency-mismatch" && c === 1) {
                            h = !0;
                            continue
                        }
                        if (h = !1,
                        ...
                        this.settings.debug && window.console && console.log("Exception occurred when checking element " + t.id + ", check the '" + r.method + "' method.", s);
...
function(n, t, i) {
    typeof define == "function" && define.amd ? define(["jquery"], n) : typeof exports == "object" ? module.exports = n(require("jquery")) : n(t || i)
}(function(n) {
    var i = function(t, i, r) {
        var u = {
            ...
            getCaret: function() {
                try {
                    ...
                    return f && navigator.appVersion.indexOf("MSIE 10") === -1 ? (n = f.createRange(),
                    n.moveStart("character", -u.val().length),
                    i = n.text.length) : (r || r === "0") && (i = r),
                    i
                } catch (o) {}
            },
            setCaret: function(n) {
                try {
                    if (t.is(":focus")) {
                        var i, r = t.get(0);
                        r.setSelectionRange ? r.setSelectionRange(n, n) : (i = r.createTextRange(),
                        i.collapse(!0),
            ...
            events: function() {
                t.on("keydown.mask", function(n) {
                    ...
                    r.selectOnFocus === !0 && n(t.target).select()
                }).on("focusout.mask", function() {
                    r.clearIfNotMatch && !o.test(u.val()) && u.val("")
                })
            },
            getRegexMask: function() {
                for (var u = [], r, e, h, s, n, o, t = 0; t < i.length; t++)
                    r = f.translation[i.charAt(t)],
                    r ? (e = r.pattern.toString().replace(/.{1}$|^.{1}/g, ""),
                    h = r.optional,
                    s = r.recursive,
                    s ? (u.push(i.charAt(t)),
                    n = {
                        digit: i.charAt(t),
                        pattern: e
                    }) : u.push(!h && !s ? e : e + "?")) : u.push(i.charAt(t).replace(/[-\/\\^$*+?.()|[\]{}]/g, "\\$&"));
                return o = u.join(""),
            ...
            val: function(n) {
                var u = t.is("input"), i = u ? "val" : "text", r;
                return arguments.length > 0 ? (t[i]() !== n && t[i](n),
                r = t) : r = t[i](),
                r
            },
            calculateCaretPosition: function(n, i) {
                var u = i.length
                  ...
                  , f = r.length;
                return t.data("mask-keycode") === 8 && r !== i ? n = n - (i.slice(0, n).length - r.slice(0, n).length) : r !== i && (n = n >= f ? u : n + (i.slice(0, n).length - r.slice(0, n).length)),
                n
            },
            behaviour: function(i) {
                ...
                u.invalid = [],
                o = t.data("mask-keycode"),
                n.inArray(o, f.byPassKeys) === -1 ? (r = u.getMasked(),
                e = u.getCaret(),
                ...
                u.val(r),
                u.setCaret(e),
                u.callbacks(i)) : void 0
            },
            getMasked: function(n, t) {
                var c = [], nt = t === undefined ? u.val() : t + "", e = 0, v = i.length, s = 0, b = nt.length, o = 1, y = "push", p = -1, l, k, d, g;
                for (r.reverse ? (y = "unshift",
                o = -1,
                l = 0,
                e = v - 1,
                s = b - 1,
                ...
                k = function() {
                    ...
                    var w = i.charAt(e)
                      , a = nt.charAt(s)
                      , h = f.translation[w];
                    h ? (a.match(h.pattern) ? (c[y](a),
                    h.recursive && (p === -1 ? p = e : e === l && (e = p - o),
                    l === p && (e -= o)),
                    e += o) : a === d ? d = undefined : h.optional ? (e += o,
                    s -= o) : h.fallback ? (c[y](h.fallback),
                    e += o,
                    s -= o) : u.invalid.push({
                        p: s,
                        v: a,
                ...
                return g = i.charAt(l),
                v !== b + 1 || f.translation[g] || c.push(g),
                c.join("")
            },
            callbacks: function(n) {
                var f = u.val()
                  ...
                  , s = [f, n, t, r]
                  , o = function(n, t, i) {
                    typeof r[n] == "function" && t && r[n].apply(this, i)
                };
                o("onChange", h === !0, s);
                o("onKeyPress", h === !0, s);
        ...
        f.init = function(e) {
            ...
            f.translation = n.extend({}, n.jMaskGlobals.translation, r.translation),
            f = n.extend(!0, {}, f, r),
            o = u.getRegexMask(),
            e)
                u.events(),
                ...
                for (r.placeholder && t.attr("placeholder", r.placeholder),
                t.data("mask") && t.attr("autocomplete", "off"),
                s = 0,
                h = !0; s < i.length; s++)
                    if (c = f.translation[i.charAt(s)],
                    c && c.recursive) {
                        h = !1;
                        break
                    }
    ...
    var u = function() {
        var t = n(this)
          ...
          , f = "data-mask-"
          , e = t.attr("data-mask");
        return t.attr(f + "reverse") && (u.reverse = !0),
        t.attr(f + "clearifnotmatch") && (u.clearIfNotMatch = !0),
        t.attr(f + "selectonfocus") === "true" && (u.selectOnFocus = !0),
        r(t, e, u) ? t.data("mask", new i(this,e,u)) : void 0
    }
      , r = function(t, i, r) {
        r = r || {};
        var u = n(t).data("mask")
          ...
          , e = n(t).val() || n(t).text();
        try {
            return typeof i == "function" && (i = i(e)),
            typeof u != "object" || f(u.options) !== f(r) || u.mask !== i
        } catch (o) {}
    }
      , f = function(n) {
    ...
    n.fn.mask = function(t, u) {
        ...
        var f = this.selector
          ...
          , o = function() {
            if (r(this, t, u))
                return n(this).data("mask", new i(this,t,u))
        };
        return n(this).each(o),
        f && f !== "" && h && (clearInterval(n.maskWatchers[f]),
    ...
    n.fn.unmask = function() {
        return clearInterval(n.maskWatchers[this.selector]),
    ...
    t = {
        ...
        watchInterval: 300,
        watchInputs: !0,
        useInput: !/Chrome\/[2-4][0-9]|SamsungBrowser/.test(window.navigator.userAgent) && f("input"),
        watchDataMask: !1,
 ...
 */
!function(n, t) {
    void 0 === n && void 0 !== window && (n = window);
    ...
    !function(n) {
        ...
        function ni(t, i) {
            ...
            if (-1 !== n.inArray(r, i))
                return -1 === n.inArray(r, kt) || Boolean(t.nodeValue.match(dt) || t.nodeValue.match(gt));
            for (var f = n(i).filter(function(n, t) {
                return t instanceof RegExp
            }), u = 0, e = f.length; u < e; u++)
                if (r.match(f[u]))
                    return !0;
            return !1
        }
        function g(n, t, i) {
            ...
            if (i && "function" == typeof i)
                return i(n);
            for (var l = Object.keys(t), u = 0, a = n.length; u < a; u++)
                for (var h = n[u].querySelectorAll("*"), f = 0, v = h.length; f < v; f++)
                    if (r = h[f],
                    e = r.nodeName.toLowerCase(),
                    -1 !== l.indexOf(e))
                        for (var c = [].slice.call(r.attributes), y = [].concat(t["*"] || [], t[e] || []), o = 0, p = c.length; o < p; o++)
                            s = c[o],
                            ni(s, y) || r.removeAttribute(s.nodeName);
                    else
                        r.parentNode.removeChild(r)
        }
        function ut(n) {
            ...
            var f = r.length
              ...
              , t = s ? Number(s) : 0;
            if (t != t && (t = 0),
            u = Math.min(Math.max(t, 0), f),
            f < o + u)
                return !1;
            for (i = -1; ++i < o; )
                if (r.charCodeAt(u + i) != e.charCodeAt(i))
                    return !1;
            return !0
        }
        function ft(n, t) {
            var i, u = n.selectedOptions, f = [], r, e;
            if (t) {
                for (r = 0,
                e = u.length; r < e; r++)
                    (i = u[r]).disabled || "OPTGROUP" === i.parentNode.tagName && i.parentNode.disabled || f.push(i);
                return f
            }
            return u
        }
        function l(n, t) {
            for (var i, r = [], f = t || n.selectedOptions, u = 0, e = f.length; u < e; u++)
                (i = f[u]).disabled || "OPTGROUP" === i.parentNode.tagName && i.parentNode.disabled || r.push(i.value);
            return n.multiple ? r : r.length ? r[0] : null
        }
        function ot(n, t, i, r) {
            for (var e, u, o = ["display", "subtext", "tokens"], s = !1, f = 0; f < o.length; f++)
                if (e = o[f],
                u = n[e],
                u && (u = u.toString(),
                "display" === e && (u = u.replace(/<[^>]+>/g, "")),
                r && (u = st(u)),
                u = u.toUpperCase(),
                s = "contains" === i ? 0 <= u.indexOf(t) : u.startsWith(t)))
                    break;
            return s
        }
        function e(n) {
        ...
        function st(n) {
            return (n = n.toString()) && n.replace(ii, ui).replace(ri, "")
        }
        function fi(n) {
            return p[n]
        }
        function yt(i) {
            var s, h = arguments, r = i, e, o, c;
            if ([].shift.apply(h),
            !f.success) {
                try {
                    f.full = (n.fn.dropdown.Constructor.VERSION || "").split(" ")[0].split(".")
                } catch (i) {
                    u.BootstrapVersion ? f.full = u.BootstrapVersion.split(" ")[0].split(".") : (f.full = [f.major, "0", "0"],
            ...
            if ("4" === f.major)
                for (e = [],
                u.DEFAULTS.style === t.BUTTONCLASS && e.push({
                    name: "style",
                    className: "BUTTONCLASS"
                }),
                u.DEFAULTS.iconBase === t.ICONBASE && e.push({
                    name: "iconBase",
                    className: "ICONBASE"
                }),
                u.DEFAULTS.tickIcon === t.TICKICON && e.push({
                    name: "tickIcon",
                    className: "TICKICON"
                }),
                ...
                o = 0; o < e.length; o++)
                    i = e[o],
                    u.DEFAULTS[i.name] = t[i.className];
            return c = this.each(function() {
                var e = n(this), t, i, o, f, c, l;
                if (e.is("select")) {
                    if (t = e.data("selectpicker"),
                    i = "object" == typeof r && r,
                    t) {
                        if (i)
                            for (o in i)
                                Object.prototype.hasOwnProperty.call(i, o) && (t.options[o] = i[o])
                    } else {
                        f = e.data();
                        for (c in f)
                            Object.prototype.hasOwnProperty.call(f, c) && -1 !== n.inArray(c, bt) && delete f[c];
                        l = n.extend({}, u.DEFAULTS, n.fn.selectpicker.defaults || {}, f, i);
                        l.template = n.extend({}, u.DEFAULTS.template, n.fn.selectpicker.defaults ? n.fn.selectpicker.defaults.template : {}, f.template, i.template);
                        e.data("selectpicker", t = new u(this,l))
                    }
                    "string" == typeof r && (s = t[r]instanceof Function ? t[r].apply(t, h) : t.options[r])
                }
            }),
            void 0 !== s ? s : c
        }
        function wt() {
            if (n.fn.dropdown)
                return (n.fn.dropdown.Constructor._dataApiKeydownHandler || n.fn.dropdown.Constructor.prototype.keydown).apply(this, arguments)
        }
        var bt = ["sanitize", "whiteList", "sanitizeFn"], kt = ["background", "cite", "href", "itemtype", "longdesc", "poster", "src", "xlink:href"], dt = /^(?:(?:https?|mailto|ftp|tel|file):|[^&:/?#]*(?:[/?#]|$))/gi, gt = /^data:(?:image\/(?:bmp|gif|jpeg|jpg|png|tiff|webp)|video\/(?:mpeg|mp4|ogg|webm)|audio\/(?:mp3|oga|ogg|opus));base64,[a-z0-9+/]+=*$/i, y, nt, h, tt, it, rt, c, s, et, p, w, ht, ct, a, pt;
            ...
            if ("Element"in t) {
                var u = "classList"
                  ...
                  , o = function() {
                    ...
                    return {
                        add: function(n) {
                            return n = Array.prototype.slice.call(arguments).join(" "),
                            t.addClass(n)
                        },
                        remove: function(n) {
                            return n = Array.prototype.slice.call(arguments).join(" "),
                ...
                if (i.defineProperty) {
                    ...
                    try {
                        i.defineProperty(f, u, r)
                    } catch (t) {
                        void 0 !== t.number && -2146823252 !== t.number || (r.enumerable = !1,
                        i.defineProperty(f, u, r))
                    }
                } else
                    i[e].__defineGetter__ && f.__defineGetter__(u, o)
            }
        }(window);
        h = document.createElement("_");
        (h.classList.add("c1", "c2"),
        h.classList.contains("c2")) || (tt = DOMTokenList.prototype.add,
        it = DOMTokenList.prototype.remove,
        DOMTokenList.prototype.add = function() {
            Array.prototype.forEach.call(arguments, tt.bind(this))
        }
        ,
        DOMTokenList.prototype.remove = function() {
            Array.prototype.forEach.call(arguments, it.bind(this))
        }
        );
        (h.classList.toggle("c3", !1),
        h.classList.contains("c3")) && (rt = DOMTokenList.prototype.toggle,
        DOMTokenList.prototype.toggle = function(n, t) {
            return 1 in arguments && !this.contains(n) == !t ? t : rt.call(this, n)
        }
        );
        h = null;
        String.prototype.startsWith || (y = function() {
            try {
                var n = {}
        ...
        nt = {}.toString,
        y ? y(String.prototype, "startsWith", {
            value: ut,
            configurable: !0,
            writable: !0
        }) : String.prototype.startsWith = ut);
        ...
        n.valHooks.select.set = function(t, i) {
            return i && !c.useDefault && n(t).data("selected", !0),
        ...
        n.fn.triggerNative = function(n) {
            var t, i = this[0];
            i.dispatchEvent ? (et ? t = new Event(n,{
                bubbles: !0
            }) : (t = document.createEvent("Event")).initEvent(n, !0, !1),
            i.dispatchEvent(t)) : i.fireEvent ? ((t = document.createEventObject()).eventType = n,
            i.fireEvent("on" + n, t)) : this.trigger(n)
        }
        ;
        var ti = {
            "À": "A",
        ...
        w = "(?:" + Object.keys(p).join("|") + ")",
        ht = RegExp(w),
        ct = RegExp(w, "g"),
        function(n) {
            return n = null == n ? "" : "" + n,
            ht.test(n) ? n.replace(ct, fi) : n
        }
        );
        var ei = {
            32: " ",
        ...
        var si = new RegExp(k + "|" + d)
          , hi = new RegExp("^" + b + "$|" + lt)
          , o = {
            li: function(n, t, r) {
                var u = i.li.cloneNode(!1);
                return n && (1 === n.nodeType || 11 === n.nodeType ? u.appendChild(n) : u.innerHTML = n),
                void 0 !== t && "" !== t && (u.className = t),
                null != r && u.classList.add("optgroup-" + r),
                u
            },
            a: function(n, t, r) {
                var u = i.a.cloneNode(!0);
                return n && (11 === n.nodeType ? u.appendChild(n) : u.insertAdjacentHTML("beforeend", n)),
                void 0 !== t && "" !== t && u.classList.add.apply(u.classList, t.split(/\s+/)),
                r && u.setAttribute("style", r),
                u
            },
            text: function(n, t) {
                var u, f, r = i.text.cloneNode(!1), e;
                if (n.content ? r.innerHTML = n.content : ((r.textContent = n.text,
                n.icon) && (e = i.whitespace.cloneNode(!1),
                (f = (!0 === t ? i.i : i.span).cloneNode(!1)).className = this.options.iconBase + " " + n.icon,
                i.fragment.appendChild(f),
                i.fragment.appendChild(e)),
                n.subtext && ((u = i.subtext.cloneNode(!1)).textContent = n.subtext,
                r.appendChild(u))),
                !0 === t)
                    for (; 0 < r.childNodes.length; )
                        i.fragment.appendChild(r.childNodes[0]);
                else
                    i.fragment.appendChild(r);
                return i.fragment
            },
            label: function(n) {
                var r, u, t = i.text.cloneNode(!1), f;
                return (t.innerHTML = n.display,
                n.icon) && (f = i.whitespace.cloneNode(!1),
                (u = i.span.cloneNode(!1)).className = this.options.iconBase + " " + n.icon,
                i.fragment.appendChild(u),
                i.fragment.appendChild(f)),
                n.subtext && ((r = i.subtext.cloneNode(!1)).textContent = n.subtext,
                t.appendChild(r)),
                i.fragment.appendChild(t),
                i.fragment
            }
        }
          , u = function(t, i) {
            var f = this, r;
            c.useDefault || (n.valHooks.select.set = c._set,
            c.useDefault = !0);
            this.$element = n(t);
            ...
            this.selectpicker = {
                ...
                keydown: {
                    ...
                    resetKeyHistory: {
                        start: function() {
                            return setTimeout(function() {
                                f.selectpicker.keydown.keyHistory = ""
                            }, 800)
                        }
                    }
                }
        ...
        u.DEFAULTS = {
            ...
            maxOptionsText: function(n, t) {
                return [1 == n ? "Limit reached ({n} item max)" : "Limit reached ({n} items max)", 1 == t ? "Group limit reached ({n} item max)" : "Group limit reached ({n} items max)"]
            },
        ...
        u.prototype = {
            ...
            init: function() {
                ...
                this.$menu = this.$newElement.children(vt.MENU);
                ...
                this.$newElement.on({
                    "hide.bs.dropdown": function(t) {
                        n.$element.trigger("hide" + r, t)
                    },
                    "hidden.bs.dropdown": function(t) {
                        n.$element.trigger("hidden" + r, t)
                    },
                    "show.bs.dropdown": function(t) {
                        n.$element.trigger("show" + r, t)
                    },
                    "shown.bs.dropdown": function(t) {
                        n.$element.trigger("shown" + r, t)
                    }
                });
                n.$element[0].hasAttribute("required") && this.$element.on("invalid" + r, function() {
                    n.$button[0].classList.add("bs-invalid");
                    n.$element.on("shown" + r + ".invalid", function() {
                        n.$element.val(n.$element.val()).off("shown" + r + ".invalid")
                    }).on("rendered" + r, function() {
                        this.validity.valid && n.$button[0].classList.remove("bs-invalid");
                        n.$element.off("rendered" + r)
                    });
                    n.$button.on("blur" + r, function() {
                ...
                setTimeout(function() {
                    n.buildList();
                    n.$element.trigger("loaded" + r)
                })
            },
            createDropdown: function() {
                var h = this.multiple || this.options.showTick ? " show-tick" : ""
                  , c = this.multiple ? ' aria-multiselectable="true"' : ""
                  , i = ""
                  , l = this.autofocus ? " autofocus" : "";
                f.major < 4 && this.$element.parent().hasClass("input-group") && (i = " input-group-btn");
                var r, u = "", e = "", o = "", s = "";
                return this.options.header && (u = '<div class="' + t.POPOVERHEADER + '"><button type="button" class="close" aria-hidden="true">&times;<\/button>' + this.options.header + "<\/div>"),
                this.options.liveSearch && (e = '<div class="bs-searchbox"><input type="search" class="form-control" autocomplete="off"' + (null === this.options.liveSearchPlaceholder ? "" : ' placeholder="' + a(this.options.liveSearchPlaceholder) + '"') + ' role="combobox" aria-label="Search" aria-controls="' + this.selectId + '" aria-autocomplete="list"><\/div>'),
                ...
                this.multiple && this.options.doneButton && (s = '<div class="bs-donebutton"><div class="btn-group btn-block"><button type="button" class="btn btn-sm ' + t.BUTTONCLASS + '">' + this.options.doneButtonText + "<\/button><\/div><\/div>"),
                r = '<div class="dropdown bootstrap-select' + h + i + '"><button type="button" tabindex="-1" class="' + this.options.styleBase + ' dropdown-toggle" ' + ("static" === this.options.display ? 'data-display="static"' : "") + 'data-toggle="dropdown"' + l + ' role="combobox" aria-owns="' + this.selectId + '" aria-haspopup="listbox" aria-expanded="false"><div class="filter-option"><div class="filter-option-inner"><div class="filter-option-inner-inner"><\/div><\/div> <\/div>' + ("4" === f.major ? "" : '<span class="bs-caret">' + this.options.template.caret + "<\/span>") + '<\/button><div class="' + t.MENU + " " + ("4" === f.major ? "" : t.SHOW) + '">' + u + e + o + '<div class="inner ' + t.SHOW + '" role="listbox" id="' + this.selectId + '" tabindex="-1" ' + c + '><ul class="' + t.MENU + " inner " + ("4" === f.major ? t.SHOW : "") + '" role="presentation"><\/ul><\/div>' + s + "<\/div><\/div>",
                n(r)
            },
            setPositionData: function() {
                var t, n, i;
                for (this.selectpicker.view.canHighlight = [],
                t = this.selectpicker.view.size = 0; t < this.selectpicker.current.data.length; t++)
                    n = this.selectpicker.current.data[t],
                    i = !0,
                    "divider" === n.type ? (i = !1,
                    n.height = this.sizeInfo.dividerHeight) : "optgroup-label" === n.type ? (i = !1,
                    n.height = this.sizeInfo.dropdownHeaderHeight) : n.height = this.sizeInfo.liHeight,
                    n.disabled && (i = !1),
                    this.selectpicker.view.canHighlight.push(i),
                    i && (this.selectpicker.view.size++,
                    n.posinset = this.selectpicker.view.size),
                    n.position = (0 === t ? 0 : this.selectpicker.current.data[t - 1].position) + n.height
            },
            isVirtual: function() {
                return !1 !== this.options.virtualScroll && this.selectpicker.main.elements.length >= this.options.virtualScroll || !0 === this.options.virtualScroll
            },
            createView: function(i, u, f) {
                function a(n, t) {
                    var c, l, rt, ut, s, b, ft, et, f = e.selectpicker.current.elements.length, k = [], ot = !0, o = e.isVirtual(), r, a, at, vt, w, nt, tt, it, yt, h;
                    for (e.selectpicker.view.scrollTop = n,
                    c = Math.ceil(e.sizeInfo.menuInnerHeight / e.sizeInfo.liHeight * 1.5),
                    l = Math.round(f / c) || 1,
                    r = 0; r < l; r++) {
                        if (a = (r + 1) * c,
                        r === l - 1 && (a = f),
                        ...
                        !f)
                            break;
                        void 0 === s && n - 1 <= e.selectpicker.current.data[a - 1].position - e.sizeInfo.menuInnerHeight && (s = r)
                    }
                    if (void 0 === s && (s = 0),
                    b = [e.selectpicker.view.position0, e.selectpicker.view.position1],
                    rt = Math.max(0, s - 1),
                    ut = Math.min(l - 1, s + 1),
                    e.selectpicker.view.position0 = !1 === o ? 0 : Math.max(0, k[rt][0]) || 0,
                    e.selectpicker.view.position1 = !1 === o ? f : Math.min(f, k[ut][1]) || 0,
                    ft = b[0] !== e.selectpicker.view.position0 || b[1] !== e.selectpicker.view.position1,
                    void 0 !== e.activeIndex && (y = e.selectpicker.main.elements[e.prevActiveIndex],
                    p = e.selectpicker.main.elements[e.activeIndex],
                    v = e.selectpicker.main.elements[e.selectedIndex],
                    t && (e.activeIndex !== e.selectedIndex && e.defocusItem(p),
                    e.activeIndex = void 0),
                    e.activeIndex && e.activeIndex !== e.selectedIndex && e.defocusItem(v)),
                    void 0 !== e.prevActiveIndex && e.prevActiveIndex !== e.activeIndex && e.prevActiveIndex !== e.selectedIndex && e.defocusItem(y),
                    (t || ft) && (et = e.selectpicker.view.visibleElements ? e.selectpicker.view.visibleElements.slice() : [],
                    e.selectpicker.view.visibleElements = !1 === o ? e.selectpicker.current.elements : e.selectpicker.current.elements.slice(e.selectpicker.view.position0, e.selectpicker.view.position1),
                    e.setOptionStatus(),
                    (i || !1 === o && t) && (ot = !function(n, t) {
                        return n.length === t.length && n.every(function(n, i) {
                            return n === t[i]
                        })
                    }(et, e.selectpicker.view.visibleElements)),
                    (t || !0 === o) && ot)) {
                        var st, ht, u = e.$menuInner[0], ct = document.createDocumentFragment(), pt = u.firstChild.cloneNode(!1), lt = e.selectpicker.view.visibleElements, d = [];
                        for (u.replaceChild(pt, u.firstChild),
                        r = 0,
                        at = lt.length; r < at; r++)
                            nt = lt[r],
                            e.options.sanitize && (vt = nt.lastChild) && (w = e.selectpicker.current.data[r + e.selectpicker.view.position0]) && w.content && !w.sanitized && (d.push(vt),
                            w.sanitized = !0),
                            ct.appendChild(nt);
                        (e.options.sanitize && d.length && g(d, e.options.whiteList, e.options.sanitizeFn),
                        !0 === o ? (st = 0 === e.selectpicker.view.position0 ? 0 : e.selectpicker.current.data[e.selectpicker.view.position0 - 1].position,
                        ht = e.selectpicker.view.position1 > f - 1 ? 0 : e.selectpicker.current.data[f - 1].position - e.selectpicker.current.data[e.selectpicker.view.position1 - 1].position,
                        u.firstChild.style.marginTop = st + "px",
                        u.firstChild.style.marginBottom = ht + "px") : (u.firstChild.style.marginTop = 0,
                        u.firstChild.style.marginBottom = 0),
                        u.firstChild.appendChild(ct),
                        !0 === o && e.sizeInfo.hasScrollBar) && (tt = u.firstChild.offsetWidth,
                        t && tt < e.sizeInfo.menuInnerInnerWidth && e.sizeInfo.totalMenuWidth > e.sizeInfo.selectWidth ? u.firstChild.style.minWidth = e.sizeInfo.menuInnerInnerWidth + "px" : tt > e.sizeInfo.menuInnerInnerWidth && (e.$menu[0].style.minWidth = 0,
                        it = u.firstChild.offsetWidth,
                        it > e.sizeInfo.menuInnerInnerWidth && (e.sizeInfo.menuInnerInnerWidth = it,
                        u.firstChild.style.minWidth = e.sizeInfo.menuInnerInnerWidth + "px"),
                        e.$menu[0].style.minWidth = ""))
                    }
                    (e.prevActiveIndex = e.activeIndex,
                    e.options.liveSearch) ? i && t && (h = 0,
                    e.selectpicker.view.canHighlight[h] || (h = 1 + e.selectpicker.view.canHighlight.slice(1).indexOf(!0)),
                    yt = e.selectpicker.view.visibleElements[h],
                    e.defocusItem(e.selectpicker.view.currentActive),
                    e.activeIndex = (e.selectpicker.current.data[h] || {}).index,
                    e.focusItem(yt)) : e.$menuInner.trigger("focus")
                }
                var v, y, e = this, o = 0, p = [], s, h, c, l;
                (this.selectpicker.isSearching = i,
                this.selectpicker.current = i ? this.selectpicker.search : this.selectpicker.main,
                this.setPositionData(),
                u) && (f ? o = this.$menuInner[0].scrollTop : e.multiple || (s = e.$element[0],
                h = (s.options[s.selectedIndex] || {}).liIndex,
                "number" == typeof h && !1 !== e.options.size && (c = e.selectpicker.main.data[h],
                l = c && c.position,
                l && (o = l - (e.sizeInfo.menuInnerHeight + e.sizeInfo.liHeight) / 2))));
                a(o, !0);
                this.$menuInner.off("scroll.createView").on("scroll.createView", function(n, t) {
                    e.noScroll || a(this.scrollTop, t);
                    e.noScroll = !1
                });
                n(window).off("resize" + r + "." + this.selectId + ".createView").on("resize" + r + "." + this.selectId + ".createView", function() {
                    e.$newElement.hasClass(t.SHOW) && a(e.$menuInner[0].scrollTop)
                })
            },
            focusItem: function(n, t, i) {
                if (n) {
                    t = t || this.selectpicker.main.data[this.activeIndex];
                    var r = n.firstChild;
                    r && (r.setAttribute("aria-setsize", this.selectpicker.view.size),
                    r.setAttribute("aria-posinset", t.posinset),
                    !0 !== i && (this.focusedParent.setAttribute("aria-activedescendant", r.id),
                    n.classList.add("active"),
                    r.classList.add("active")))
                }
            },
            defocusItem: function(n) {
            ...
            setPlaceholder: function() {
                ...
                if (this.options.title && !this.multiple) {
                    ...
                    var n = this.$element[0]
                      , r = !1
                      , u = !this.selectpicker.view.titleOption.parentNode
                      , f = n.selectedIndex
                      , e = n.options[f]
                      , o = window.performance && window.performance.getEntriesByType("navigation");
                    u && (this.selectpicker.view.titleOption.className = "bs-title-option",
                    this.selectpicker.view.titleOption.value = "",
                    r = !e || 0 === f && !1 === e.defaultSelected && void 0 === this.$element.data("selected"));
                    !u && 0 === this.selectpicker.view.titleOption.index || n.insertBefore(this.selectpicker.view.titleOption, n.firstChild);
                    r && o.length && "back_forward" !== o[0].type ? n.selectedIndex = 0 : "complete" !== document.readyState && window.addEventListener("pageshow", function() {
                        t.selectpicker.view.displayedValue !== n.value && t.render()
                    })
                }
                return i
            },
            buildData: function() {
                function f(t) {
                    var i = n[n.length - 1];
                    i && "divider" === i.type && (i.optID || t.optID) || ((t = t || {}).type = "divider",
                    n.push(t))
                }
                function s(t, i) {
                    if ((i = i || {}).divider = "true" === t.getAttribute("data-divider"),
                    i.divider)
                        f({
                            optID: i.optID
                        });
                ...
                function c(t, r) {
                    var e = r[t], b = !(t - 1 < o) && r[t - 1], k = r[t + 1], l = e.querySelectorAll("option" + u), y, p, h, c, v, w;
                    if (l.length) {
                        for (h = {
                            display: a(e.label),
                            subtext: e.getAttribute("data-subtext"),
                            icon: e.getAttribute("data-icon"),
                            type: "optgroup-label",
                            optgroupClass: " " + (e.className || "")
                        },
                        i++,
                        b && f({
                            optID: i
                ...
                var u = ':not([hidden]):not([data-hidden="true"])', n = [], i = 0, o = this.setPlaceholder() ? 1 : 0, r, h, t, e;
                for (this.options.hideDisabled && (u += ":not(:disabled)"),
                r = this.$element[0].querySelectorAll("select > *" + u),
                h = r.length,
                t = o; t < h; t++)
                    e = r[t],
                    "OPTGROUP" !== e.tagName ? s(e, {}) : c(t, r);
            ...
            buildList: function() {
                function h(i) {
                    ...
                    switch (i.type) {
                    case "divider":
                        u = o.li(!1, t.DIVIDER, i.optID ? i.optID + "div" : void 0);
                        break;
                    case "option":
                        (u = o.li(o.a(o.text.call(n, i), i.optionClass, i.inlineStyle), "", i.optID)).firstChild && (u.firstChild.id = n.selectId + "-" + i.index);
                        break;
                    case "optgroup-label":
                        u = o.li(o.label.call(n, i), "dropdown-header" + i.optgroupClass, i.optID)
                    }
                    i.element = u;
                    r.push(u);
                    i.display && (f += i.display.length);
                    i.subtext && (f += i.subtext.length);
                    i.icon && (f += 1);
                    e < f && (e = f,
                    n.selectpicker.view.widestOption = r[r.length - 1])
                }
                var n = this, f = this.selectpicker.main.data, r = [], e = 0, s, u;
                for ((n.options.showTick || n.multiple) && !i.checkMark.parentNode && (i.checkMark.className = this.options.iconBase + " " + n.options.tickIcon + " check-mark",
            ...
            render: function() {
                var b, t = this, y = this.$element[0], rt = this.setPlaceholder() && 0 === y.selectedIndex, a = ft(y, this.options.hideDisabled), u = a.length, e = this.$button[0], k = e.querySelector(".filter-option-inner-inner"), ut = document.createTextNode(this.options.multipleSeparator), n = i.fragment.cloneNode(!1), tt = !1, s, v, d, it, nt, w;
                if (e.classList.toggle("bs-placeholder", t.multiple ? !u : !l(y, a)),
                t.multiple || 1 !== a.length || (t.selectpicker.view.displayedValue = l(y, a)),
                "static" === this.options.selectedTextFormat)
                    n = o.text.call(this, {
                        text: this.options.title
                    }, !0);
                else if (!1 === (this.multiple && -1 !== this.options.selectedTextFormat.indexOf("count") && 1 < u && (1 < (b = this.options.selectedTextFormat.split(">")).length && u > b[1] || 1 === b.length && 2 <= u))) {
                    if (!rt) {
                        for (s = 0; s < u && s < 50; s++) {
                            var p = a[s]
                              , h = this.selectpicker.main.data[p.liIndex]
                              , c = {};
                            this.multiple && 0 < s && n.appendChild(ut.cloneNode(!1));
                            p.title ? c.text = p.title : h && (h.content && t.options.showContent ? (c.content = h.content.toString(),
                            tt = !0) : (t.options.showIcon && (c.icon = h.icon),
                            t.options.showSubtext && !t.multiple && h.subtext && (c.subtext = " " + h.subtext),
                            c.text = p.textContent.trim()));
                            n.appendChild(o.text.call(this, c, !0))
                        }
                        49 < u && n.appendChild(document.createTextNode("..."))
                    }
                } else
                    v = ':not([hidden]):not([data-hidden="true"]):not([data-divider="true"])',
                    this.options.hideDisabled && (v += ":not(:disabled)"),
                    d = this.$element[0].querySelectorAll("select > option" + v + ", optgroup" + v + " option" + v).length,
                    it = "function" == typeof this.options.countSelectedText ? this.options.countSelectedText(u, d) : this.options.countSelectedText,
                    n = o.text.call(this, {
                        text: it.replace("{0}", u.toString()).replace("{1}", d.toString())
                    }, !0);
                (null == this.options.title && (this.options.title = this.$element.attr("title")),
                n.childNodes.length || (n = o.text.call(this, {
                    text: void 0 !== this.options.title ? this.options.title : this.options.noneSelectedText
                }, !0)),
                e.title = n.textContent.replace(/<[^>]*>?/g, "").trim(),
                this.options.sanitize && tt && g([n], t.options.whiteList, t.options.sanitizeFn),
                k.innerHTML = "",
                k.appendChild(n),
                f.major < 4 && this.$newElement[0].classList.contains("bs3-has-addon")) && (nt = e.querySelector(".filter-expand"),
                w = k.cloneNode(!0),
                w.className = "filter-expand",
                nt ? e.replaceChild(w, nt) : e.appendChild(w));
                this.$element.trigger("rendered" + r)
            },
            setStyle: function(n, t) {
                var u, i = this.$button[0], r = this.$newElement[0], e = this.options.style.trim();
                this.$element.attr("class") && this.$newElement.addClass(this.$element.attr("class").replace(/selectpicker|mobile-device|bs-select-hidden|validate\[.*\]/gi, ""));
                f.major < 4 && (r.classList.add("bs3"),
                r.parentNode.classList && r.parentNode.classList.contains("input-group") && (r.previousElementSibling || r.nextElementSibling) && (r.previousElementSibling || r.nextElementSibling).classList.contains("input-group-addon") && r.classList.add("bs3-has-addon"));
                u = n ? n.trim() : e;
                "add" == t ? u && i.classList.add.apply(i.classList, u.split(" ")) : "remove" == t ? u && i.classList.remove.apply(i.classList, u.split(" ")) : (e && i.classList.remove.apply(i.classList, e.split(" ")),
                u && i.classList.add.apply(i.classList, u.split(" ")))
            },
            liHeight: function(r) {
                var d, it, rt;
                if (r || !1 !== this.options.size && !Object.keys(this.sizeInfo).length) {
                    var l, a = i.div.cloneNode(!1), o = i.div.cloneNode(!1), y = i.div.cloneNode(!1), h = document.createElement("ul"), nt = i.li.cloneNode(!1), v = i.li.cloneNode(!1), tt = i.a.cloneNode(!1), p = i.span.cloneNode(!1), w = this.options.header && 0 < this.$menu.find("." + t.POPOVERHEADER).length ? this.$menu.find("." + t.POPOVERHEADER)[0].cloneNode(!0) : null, c = this.options.liveSearch ? i.div.cloneNode(!1) : null, b = this.options.actionsBox && this.multiple && 0 < this.$menu.find(".bs-actionsbox").length ? this.$menu.find(".bs-actionsbox")[0].cloneNode(!0) : null, k = this.options.doneButton && this.multiple && 0 < this.$menu.find(".bs-donebutton").length ? this.$menu.find(".bs-donebutton")[0].cloneNode(!0) : null, ft = this.$element.find("option")[0];
                    if (this.sizeInfo.selectWidth = this.$newElement[0].offsetWidth,
                    p.className = "text",
                    tt.className = "dropdown-item " + (ft ? ft.className : ""),
                    a.className = this.$menu[0].parentNode.className + " " + t.SHOW,
                    a.style.width = 0,
                    "auto" === this.options.width && (o.style.minWidth = 0),
                    o.className = t.MENU + " " + t.SHOW,
                    y.className = "inner " + t.SHOW,
                    h.className = t.MENU + " inner " + ("4" === f.major ? t.SHOW : ""),
                    nt.className = t.DIVIDER,
                    v.className = "dropdown-header",
                    p.appendChild(document.createTextNode("​")),
                    this.selectpicker.current.data.length) {
                        for (d = 0; d < this.selectpicker.current.data.length; d++)
                            if (it = this.selectpicker.current.data[d],
                            "option" === it.type) {
                                l = it.element;
                                break
                            }
                        ...
                        tt.appendChild(p),
                        l.appendChild(tt);
                    (v.appendChild(p.cloneNode(!0)),
                    this.selectpicker.view.widestOption && h.appendChild(this.selectpicker.view.widestOption.cloneNode(!0)),
                    h.appendChild(l),
                    h.appendChild(nt),
                    h.appendChild(v),
                    w && o.appendChild(w),
                    c) && (rt = document.createElement("input"),
                    c.className = "bs-searchbox",
                    rt.className = "form-control",
                    c.appendChild(rt),
                    o.appendChild(c));
                    b && o.appendChild(b);
                    y.appendChild(h);
                    ...
                    var et, ot = l.offsetHeight, st = v ? v.offsetHeight : 0, ht = w ? w.offsetHeight : 0, ct = c ? c.offsetHeight : 0, lt = b ? b.offsetHeight : 0, at = k ? k.offsetHeight : 0, vt = n(nt).outerHeight(!0), u = !!window.getComputedStyle && window.getComputedStyle(o), ut = o.offsetWidth, s = u ? null : n(o), g = {
                        vert: e(u ? u.paddingTop : s.css("paddingTop")) + e(u ? u.paddingBottom : s.css("paddingBottom")) + e(u ? u.borderTopWidth : s.css("borderTopWidth")) + e(u ? u.borderBottomWidth : s.css("borderBottomWidth")),
                        horiz: e(u ? u.paddingLeft : s.css("paddingLeft")) + e(u ? u.paddingRight : s.css("paddingRight")) + e(u ? u.borderLeftWidth : s.css("borderLeftWidth")) + e(u ? u.borderRightWidth : s.css("borderRightWidth"))
                    }, yt = {
                        vert: g.vert + e(u ? u.marginTop : s.css("marginTop")) + e(u ? u.marginBottom : s.css("marginBottom")) + 2,
                        horiz: g.horiz + e(u ? u.marginLeft : s.css("marginLeft")) + e(u ? u.marginRight : s.css("marginRight")) + 2
                    };
                    y.style.overflowY = "scroll";
                    et = o.offsetWidth - ut;
                    document.body.removeChild(a);
                    this.sizeInfo.liHeight = ot;
                    this.sizeInfo.dropdownHeaderHeight = st;
                    this.sizeInfo.headerHeight = ht;
                    this.sizeInfo.searchHeight = ct;
                    this.sizeInfo.actionsHeight = lt;
                    this.sizeInfo.doneButtonHeight = at;
                    this.sizeInfo.dividerHeight = vt;
                    this.sizeInfo.menuPadding = g;
                    this.sizeInfo.menuExtras = yt;
                    this.sizeInfo.menuWidth = ut;
                    this.sizeInfo.menuInnerInnerWidth = ut - g.horiz;
                    this.sizeInfo.totalMenuWidth = this.sizeInfo.menuWidth;
                    this.sizeInfo.scrollBarWidth = et;
                    this.sizeInfo.selectHeight = this.$newElement[0].offsetHeight;
                    this.setPositionData()
                }
            },
            getSelectPosition: function() {
                var t, u = n(window), f = this.$newElement.offset(), i = n(this.options.container), r;
                this.options.container && i.length && !i.is("body") ? ((t = i.offset()).top += parseInt(i.css("borderTopWidth")),
                t.left += parseInt(i.css("borderLeftWidth"))) : t = {
                    top: 0,
                    left: 0
                };
                r = this.options.windowPadding;
                this.sizeInfo.selectOffsetTop = f.top - t.top - u.scrollTop();
                this.sizeInfo.selectOffsetBot = u.height() - this.sizeInfo.selectOffsetTop - this.sizeInfo.selectHeight - t.top - r[2];
                this.sizeInfo.selectOffsetLeft = f.left - t.left - u.scrollLeft();
                this.sizeInfo.selectOffsetRight = u.width() - this.sizeInfo.selectOffsetLeft - this.sizeInfo.selectWidth - t.left - r[1];
            ...
            setMenuSize: function() {
                ...
                var r, n, e, o, s, h, y, u, b = this.sizeInfo.selectWidth, p = this.sizeInfo.liHeight, c = this.sizeInfo.headerHeight, l = this.sizeInfo.searchHeight, a = this.sizeInfo.actionsHeight, v = this.sizeInfo.doneButtonHeight, k = this.sizeInfo.dividerHeight, i = this.sizeInfo.menuPadding, w = 0;
                if (this.options.dropupAuto && (y = p * this.selectpicker.current.elements.length + i.vert,
                u = this.sizeInfo.selectOffsetTop - this.sizeInfo.selectOffsetBot > this.sizeInfo.menuExtras.vert && y + this.sizeInfo.menuExtras.vert + 50 > this.sizeInfo.selectOffsetBot,
                !0 === this.selectpicker.isSearching && (u = this.selectpicker.dropup),
                this.$newElement.toggleClass(t.DROPUP, u),
                this.selectpicker.dropup = u),
                "auto" === this.options.size)
                    o = 3 < this.selectpicker.current.elements.length ? 3 * this.sizeInfo.liHeight + this.sizeInfo.menuExtras.vert - 2 : 0,
                    n = this.sizeInfo.selectOffsetBot - this.sizeInfo.menuExtras.vert,
                    e = o + c + l + a + v,
                    h = Math.max(o - i.vert, 0),
                    this.$newElement.hasClass(t.DROPUP) && (n = this.sizeInfo.selectOffsetTop - this.sizeInfo.menuExtras.vert),
                    r = (s = n) - c - l - a - v - i.vert;
                else if (this.options.size && "auto" != this.options.size && this.selectpicker.current.elements.length > this.options.size) {
                    for (f = 0; f < this.options.size; f++)
                        "divider" === this.selectpicker.current.data[f].type && w++;
                    r = (n = p * this.options.size + w * k + i.vert) - i.vert;
                    s = n + c + l + a + v;
                    e = h = ""
                }
                this.$menu.css({
                ...
                "auto" === this.options.dropdownAlignRight && this.$menu.toggleClass(t.MENURIGHT, this.sizeInfo.selectOffsetLeft > this.sizeInfo.selectOffsetRight && this.sizeInfo.selectOffsetRight < this.sizeInfo.totalMenuWidth - b);
            ...
            setSize: function(t) {
                ...
                !1 !== this.options.size) {
                    ...
                    "auto" === this.options.size ? u.off("resize" + r + "." + this.selectId + ".setMenuSize scroll" + r + "." + this.selectId + ".setMenuSize").on("resize" + r + "." + this.selectId + ".setMenuSize scroll" + r + "." + this.selectId + ".setMenuSize", function() {
                        return i.setMenuSize()
                    }) : this.options.size && "auto" != this.options.size && this.selectpicker.current.elements.length > this.options.size && u.off("resize" + r + "." + this.selectId + ".setMenuSize scroll" + r + "." + this.selectId + ".setMenuSize")
                }
            ...
            setWidth: function() {
                ...
                "auto" === this.options.width ? requestAnimationFrame(function() {
                    ...
                    n.$element.on("loaded" + r, function() {
                        n.liHeight();
                        n.setMenuSize();
                        var t = n.$newElement.clone().appendTo("body")
                          , i = t.css("width", "auto").children("button").outerWidth();
                        t.remove();
                        n.sizeInfo.selectWidth = Math.max(n.sizeInfo.totalMenuWidth, i);
            ...
            selectPosition: function() {
                function s(r) {
                    var s = {}
                      , c = i.options.display || !!n.fn.dropdown.Constructor.Default && n.fn.dropdown.Constructor.Default.display;
                    i.$bsContainer.addClass(r.attr("class").replace(/form-control|fit-width/gi, "")).toggleClass(t.DROPUP, r.hasClass(t.DROPUP));
                    o = r.offset();
                    u.is("body") ? e = {
                        top: 0,
                        left: 0
                    } : ((e = u.offset()).top += parseInt(u.css("borderTopWidth")) - u.scrollTop(),
                    e.left += parseInt(u.css("borderLeftWidth")) - u.scrollLeft());
                    h = r.hasClass(t.DROPUP) ? 0 : r[0].offsetHeight;
                    (f.major < 4 || "static" === c) && (s.top = o.top - e.top + h,
                    s.left = o.left - e.left);
                    s.width = r[0].offsetWidth;
                    i.$bsContainer.css(s)
                }
                this.$bsContainer = n('<div class="bs-container" />');
                var o, e, h, i = this, u = n(this.options.container);
                this.$button.on("click.bs.dropdown.data-api", function() {
                    i.isDisabled() || (s(i.$newElement),
                    i.$bsContainer.appendTo(i.options.container).toggleClass(t.SHOW, !i.$button.hasClass(t.SHOW)).append(i.$menu))
                });
                n(window).off("resize" + r + "." + this.selectId + " scroll" + r + "." + this.selectId).on("resize" + r + "." + this.selectId + " scroll" + r + "." + this.selectId, function() {
                    i.$newElement.hasClass(t.SHOW) && s(i.$newElement)
                });
            ...
            setOptionStatus: function(n) {
                var t = this, r, i, u;
                if (t.noScroll = !1,
                t.selectpicker.view.visibleElements && t.selectpicker.view.visibleElements.length)
                    for (r = 0; r < t.selectpicker.view.visibleElements.length; r++)
                        i = t.selectpicker.current.data[r + t.selectpicker.view.position0],
                        u = i.option,
                        u && (!0 !== n && t.setDisabled(i.index, i.disabled),
                        t.setSelected(i.index, u.selected))
            },
            setSelected: function(n, t) {
                var u, i, r = this.selectpicker.main.elements[n], f = this.selectpicker.main.data[n], e = void 0 !== this.activeIndex, o = this.activeIndex === n || t && !this.multiple && !e;
                f.selected = t;
                i = r.firstChild;
                t && (this.selectedIndex = n);
                r.classList.toggle("selected", t);
                o ? (this.focusItem(r, f),
                this.selectpicker.view.currentActive = r,
                this.activeIndex = n) : this.defocusItem(r);
                ...
                o || e || !t || void 0 === this.prevActiveIndex || (u = this.selectpicker.main.elements[this.prevActiveIndex],
                this.defocusItem(u))
            },
            setDisabled: function(n, i) {
                var r, u = this.selectpicker.main.elements[n];
                this.selectpicker.main.data[n].disabled = i;
                r = u.firstChild;
                u.classList.toggle(t.DISABLED, i);
                r && ("4" === f.major && r.classList.toggle(t.DISABLED, i),
                i ? (r.setAttribute("aria-disabled", i),
                r.setAttribute("tabindex", -1)) : (r.removeAttribute("aria-disabled"),
            ...
            checkDisabled: function() {
                this.isDisabled() ? (this.$newElement[0].classList.add(t.DISABLED),
                this.$button.addClass(t.DISABLED).attr("aria-disabled", !0)) : this.$button[0].classList.contains(t.DISABLED) && (this.$newElement[0].classList.remove(t.DISABLED),
            ...
            clickListener: function() {
                ...
                function o() {
                    i.dropdown && i.dropdown._popper && i.dropdown._popper.state.isCreated ? e() : requestAnimationFrame(o)
                }
                var i = this
                  , u = n(document);
                u.data("spaceSelect", !1);
                this.$button.on("keyup", function(n) {
                    /(32)/.test(n.keyCode.toString(10)) && u.data("spaceSelect") && (n.preventDefault(),
                    u.data("spaceSelect", !1))
                });
                this.$newElement.on("show.bs.dropdown", function() {
                    3 < f.major && !i.dropdown && (i.dropdown = i.$button.data("bs.dropdown"),
                ...
                this.$element.on("shown" + r, function() {
                    ...
                    3 < f.major ? requestAnimationFrame(o) : e()
                });
                this.$menuInner.on("mouseenter", "li a", function() {
                    var n = this.parentElement
                      , t = i.isVirtual() ? i.selectpicker.view.position0 : 0
                      , r = Array.prototype.indexOf.call(n.parentElement.children, n)
                      , u = i.selectpicker.current.data[r + t];
                    i.focusItem(n, u, !0)
                });
                this.$menuInner.on("click", "li a", function(u, f) {
                    var w = n(this), c = i.$element[0], lt = i.isVirtual() ? i.selectpicker.view.position0 : 0, ut = i.selectpicker.current.data[w.parent().index() + lt], a = ut.index, at = l(c), et = c.selectedIndex, ot = c.options[et], b = !0, d, g, p, nt;
                    if (i.multiple && 1 !== i.options.maxOptions && u.stopPropagation(),
                    u.preventDefault(),
                    !i.isDisabled() && !w.parent().hasClass(t.DISABLED)) {
                        var h = ut.option
                          , st = n(h)
                          , ht = h.selected
                          , k = st.parent("optgroup")
                          , ct = k.find("option")
                          , e = i.options.maxOptions
                          , o = k.data("maxOptions") || !1;
                        if (a === i.activeIndex && (f = !0),
                        f || (i.prevActiveIndex = i.activeIndex,
                        i.activeIndex = void 0),
                        i.multiple) {
                            if ((h.selected = !ht,
                            i.setSelected(a, !ht),
                            w.trigger("blur"),
                            !1 !== e || !1 !== o) && (d = e < ft(c).length,
                            g = o < k.find("option:selected").length,
                            e && d || o && g))
                                if (e && 1 == e)
                                    c.selectedIndex = -1,
                                    h.selected = !0,
                                    ...
                                    for (p = 0; p < ct.length; p++)
                                        nt = ct[p],
                                        nt.selected = !1,
                                        i.setSelected(nt.liIndex, !1);
                                    h.selected = !0;
                                    i.setSelected(a, !0)
                                } else {
                                    var tt = "string" == typeof i.options.maxOptionsText ? [i.options.maxOptionsText, i.options.maxOptionsText] : i.options.maxOptionsText
                                      , v = "function" == typeof tt ? tt(e, o) : tt
                                      , it = v[0].replace("{n}", e)
                                      , rt = v[1].replace("{n}", o)
                                      , y = n('<div class="notify"><\/div>');
                                    v[2] && (it = it.replace("{var}", v[2][1 < e ? 0 : 1]),
                                    rt = rt.replace("{var}", v[2][1 < o ? 0 : 1]));
                                    h.selected = !1;
                                    i.$menu.append(y);
                                    e && d && (y.append(n("<div>" + it + "<\/div>")),
                                    b = !1,
                                    i.$element.trigger("maxReached" + r));
                                    o && g && (y.append(n("<div>" + rt + "<\/div>")),
                                    b = !1,
                                    i.$element.trigger("maxReachedGrp" + r));
                                    setTimeout(function() {
                                        i.setSelected(a, !1)
                                    }, 10);
                        ...
                        b && (!i.multiple && et === c.selectedIndex || (s = [h.index, st.prop("selected"), at],
                        i.$element.triggerNative("change")))
                    }
                });
                this.$menu.on("click", "li." + t.DISABLED + " a, ." + t.POPOVERHEADER + ", ." + t.POPOVERHEADER + " :not(.close)", function(t) {
                    t.currentTarget == this && (t.preventDefault(),
                    t.stopPropagation(),
                    i.options.liveSearch && !n(t.target).hasClass("close") ? i.$searchbox.trigger("focus") : i.$button.trigger("focus"))
                });
                ...
                this.$menu.on("click", ".actions-btn", function(t) {
                    ...
                    t.preventDefault();
                    t.stopPropagation();
                    n(this).hasClass("bs-select-all") ? i.selectAll() : i.deselectAll()
                });
                this.$button.on("focus" + r, function(n) {
                    var t = i.$element[0].getAttribute("tabindex");
                    void 0 !== t && n.originalEvent && n.originalEvent.isTrusted && (this.setAttribute("tabindex", t),
                    i.$element[0].setAttribute("tabindex", -1),
                    i.selectpicker.view.tabindex = t)
                }).on("blur" + r, function(n) {
                    void 0 !== i.selectpicker.view.tabindex && n.originalEvent && n.originalEvent.isTrusted && (i.$element[0].setAttribute("tabindex", i.selectpicker.view.tabindex),
                    this.setAttribute("tabindex", -1),
                    i.selectpicker.view.tabindex = void 0)
                });
                this.$element.on("change" + r, function() {
                    i.render();
                    i.$element.trigger("changed" + r, s);
                    s = null
                }).on("focus" + r, function() {
            ...
            liveSearchListener: function() {
                ...
                this.$searchbox.on("click.bs.dropdown.data-api focus.bs.dropdown.data-api touchend.bs.dropdown.data-api", function(n) {
                    n.stopPropagation()
                });
                this.$searchbox.on("input propertychange", function() {
                    var e = n.$searchbox.val(), t, r, h;
                    if (n.selectpicker.search.elements = [],
                    n.selectpicker.search.data = [],
                    e) {
                        var o = []
                          , s = e.toUpperCase()
                          , u = {}
                          , f = []
                          , y = n._searchStyle()
                          , c = n.options.liveSearchNormalize;
                        for (c && (s = st(s)),
                        t = 0; t < n.selectpicker.main.data.length; t++)
                            r = n.selectpicker.main.data[t],
                            u[t] || (u[t] = ot(r, s, y, c)),
                            u[t] && void 0 !== r.headerIndex && -1 === f.indexOf(r.headerIndex) && (0 < r.headerIndex && (u[r.headerIndex - 1] = !0,
                            f.push(r.headerIndex - 1)),
                            u[r.headerIndex] = !0,
                            f.push(r.headerIndex),
                            u[r.lastIndex + 1] = !0),
                            u[t] && "optgroup-label" !== r.type && f.push(t);
                        for (t = 0,
                        h = f.length; t < h; t++) {
                            var l = f[t]
                              , p = f[t - 1]
                              , v = (r = n.selectpicker.main.data[l],
                            n.selectpicker.main.data[p]);
                            ("divider" !== r.type || "divider" === r.type && v && "divider" !== v.type && h - 1 !== t) && (n.selectpicker.search.data.push(r),
                            o.push(n.selectpicker.main.elements[l]))
                        }
                        n.activeIndex = void 0;
                        n.noScroll = !0;
                        n.$menuInner.scrollTop(0);
                        n.selectpicker.search.elements = o;
                        n.createView(!0),
                        function(n, t) {
                            n.length || (i.noResults.innerHTML = this.options.noneResultsText.replace("{0}", '"' + a(t) + '"'),
            ...
            val: function(n) {
                var i = this.$element[0], f, u;
                return void 0 === n ? this.$element.val() : (f = l(i),
                (s = [null, null, f],
                this.$element.val(n).trigger("changed" + r, s),
                this.$newElement.hasClass(t.SHOW)) && (this.multiple ? this.setOptionStatus(!0) : (u = (i.options[i.selectedIndex] || {}).liIndex,
                "number" == typeof u && (this.setSelected(this.selectedIndex, !1),
            ...
            changeAll: function(n) {
                ...
                if (this.multiple) {
                    ...
                    for (var r = 0, o = this.selectpicker.current.data, c = o.length; r < c; r++)
                        t = o[r],
                        u = t.option,
                        u && !t.disabled && "divider" !== t.type && (t.selected && f++,
                        !0 === (u.selected = n) && e++);
                    i.classList.remove("bs-select-hidden");
                    f !== e && (this.setOptionStatus(),
                    s = [null, null, h],
            ...
            toggle: function(n) {
                (n = n || window.event) && n.stopPropagation();
                this.$button.trigger("click.bs.dropdown.data-api")
            },
            keydown: function(i) {
                var u, tt, f, o, a, s = n(this), ft = s.hasClass("dropdown-toggle"), r = (ft ? s.closest(".dropdown") : s.closest(vt.MENU)).data("this"), p = r.findLis(), w = !1, it = i.which === b && !ft && !r.options.selectOnTab, et = si.test(i.which) || it, nt = r.$menuInner[0].scrollTop, e = !0 === r.isVirtual() ? r.selectpicker.view.position0 : 0, h, rt, y, c, g, ut, l;
                if (!(112 <= i.which && i.which <= 123))
                    if ((tt = r.$newElement.hasClass(t.SHOW)) || !(et || 48 <= i.which && i.which <= 57 || 96 <= i.which && i.which <= 105 || 65 <= i.which && i.which <= 90) || (r.$button.trigger("click.bs.dropdown.data-api"),
                    !r.options.liveSearch)) {
                        if (i.which === lt && tt && (i.preventDefault(),
                        r.$button.trigger("click.bs.dropdown.data-api").trigger("focus")),
                        et) {
                            if (!p.length)
                                return;
                            -1 !== (u = (f = r.selectpicker.main.elements[r.activeIndex]) ? Array.prototype.indexOf.call(f.parentElement.children, f) : -1) && r.defocusItem(f);
                            i.which === k ? (-1 !== u && u--,
                            u + e < 0 && (u += p.length),
                            r.selectpicker.view.canHighlight[u + e] || -1 == (u = r.selectpicker.view.canHighlight.slice(0, u + e).lastIndexOf(!0) - e) && (u = p.length - 1)) : i.which !== d && !it || (++u + e >= r.selectpicker.view.canHighlight.length && (u = 0),
                            r.selectpicker.view.canHighlight[u + e] || (u = u + 1 + r.selectpicker.view.canHighlight.slice(u + e + 1).indexOf(!0)));
                            i.preventDefault();
                            h = e + u;
                            i.which === k ? 0 === e && u === p.length - 1 ? (r.$menuInner[0].scrollTop = r.$menuInner[0].scrollHeight,
                            h = r.selectpicker.current.elements.length - 1) : w = (a = (o = r.selectpicker.current.data[h]).position - o.height) < nt : i.which !== d && !it || (0 === u ? h = r.$menuInner[0].scrollTop = 0 : w = nt < (a = (o = r.selectpicker.current.data[h]).position - r.sizeInfo.menuInnerHeight));
                            f = r.selectpicker.current.elements[h];
                            r.activeIndex = r.selectpicker.current.data[h].index;
                            r.focusItem(f);
                            r.selectpicker.view.currentActive = f;
                            w && (r.$menuInner[0].scrollTop = a);
                            r.options.liveSearch ? r.$searchbox.trigger("focus") : s.trigger("focus")
                        } else if (!s.is("input") && !hi.test(i.which) || i.which === v && r.selectpicker.keydown.keyHistory) {
                            for (c = [],
                            i.preventDefault(),
                            r.selectpicker.keydown.keyHistory += ei[i.which],
                            ...
                            y = r.selectpicker.keydown.keyHistory,
                            /^(.)\1+$/.test(y) && (y = y.charAt(0)),
                            g = 0; g < r.selectpicker.current.data.length; g++)
                                ut = r.selectpicker.current.data[g],
                                ot(ut, y, "startsWith", !0) && r.selectpicker.view.canHighlight[g] && c.push(ut.index);
                            c.length && (l = 0,
                            p.removeClass("active").find("a").removeClass("active"),
                            1 === y.length && (-1 === (l = c.indexOf(r.activeIndex)) || l === c.length - 1 ? l = 0 : l++),
                            rt = c[l],
                            w = 0 < nt - (o = r.selectpicker.main.data[rt]).position ? (a = o.position - o.height,
                            !0) : (a = o.position - r.sizeInfo.menuInnerHeight,
                            o.position > nt + r.sizeInfo.menuInnerHeight),
                            f = r.selectpicker.main.elements[rt],
                            r.activeIndex = c[l],
                            r.focusItem(f),
                            f && f.firstChild.focus(),
                            w && (r.$menuInner[0].scrollTop = a),
                            s.trigger("focus"))
                        }
                        tt && (i.which === v && !r.selectpicker.keydown.keyHistory || i.which === oi || i.which === b && r.options.selectOnTab) && (i.which !== v && i.preventDefault(),
                        r.options.liveSearch && i.which === v || (r.$menuInner.find(".active a").trigger("click", !0),
                        s.trigger("focus"),
                        r.options.liveSearch || (i.preventDefault(),
            ...
            refresh: function() {
                var t = n.extend({}, this.options, this.$element.data());
                this.options = t;
                this.checkDisabled();
                this.buildData();
                this.setStyle();
            ...
            destroy: function() {
                ...
                n(window).off(r + "." + this.selectId)
            }
        };
        pt = n.fn.selectpicker;
        n.fn.selectpicker = yt;
        n.fn.selectpicker.Constructor = u;
        n.fn.selectpicker.noConflict = function() {
            return n.fn.selectpicker = pt,
            this
        }
        ;
        n(document).off("keydown.bs.dropdown.data-api").on("keydown.bs.dropdown.data-api", ':not(.bootstrap-select) > [data-toggle="dropdown"]', wt).on("keydown.bs.dropdown.data-api", ":not(.bootstrap-select) > .dropdown-menu", wt).on("keydown" + r, '.bootstrap-select [data-toggle="dropdown"], .bootstrap-select [role="listbox"], .bootstrap-select .bs-searchbox input', u.prototype.keydown).on("focusin.modal", '.bootstrap-select [data-toggle="dropdown"], .bootstrap-select [role="listbox"], .bootstrap-select .bs-searchbox input', function(n) {
            n.stopPropagation()
        });
        n(window).on("load" + r + ".data-api", function() {
...
function(n) {
    ...
    var a = function() {
        ...
        this.isInline = this.o.isInline === null ? !this.component && !this.isInput : this.o.isInline;
    ...
    u.prototype = {
        ...
        _process_options: function(t) {
            ...
            u.startDate !== -Infinity && (u.startDate = u.startDate ? u.startDate instanceof Date ? this._local_to_utc(this._zero_time(u.startDate)) : i.parseDate(u.startDate, l, u.language, u.assumeNearbyYear) : -Infinity),
            u.endDate !== Infinity && (u.endDate = u.endDate ? u.endDate instanceof Date ? this._local_to_utc(this._zero_time(u.endDate)) : i.parseDate(u.endDate, l, u.language, u.assumeNearbyYear) : Infinity),
            ...
            s = String(u.orientation).toLowerCase().split(/\s+/g),
            ...
            if (u.defaultViewDate instanceof Date || typeof u.defaultViewDate == "string")
        ...
        _trigger: function(t, r) {
            ...
            this.element.trigger({
                ...
                format: n.proxy(function(n, t) {
                    arguments.length === 0 ? (n = this.dates.length - 1,
                    t = this.o.format) : typeof n == "string" && (t = n,
        ...
        _utc_to_local: function(n) {
            ...
            return t.getTimezoneOffset() !== n.getTimezoneOffset() && (t = new Date(n.getTime() + t.getTimezoneOffset() * 6e4)),
            t
        },
        ...
        place: function() {
            ...
            this.element.parents().each(function() {
                ...
                t !== "auto" && Number(t) !== 0 && a.push(Number(t))
            });
            var v = Math.max.apply(Math, a) + this.o.zIndexOffset
              ...
              , t = u.left - l.left
              , i = u.top - l.top;
            return this.o.container !== "body" && (i += c),
            this.picker.removeClass("datepicker-orient-top datepicker-orient-bottom datepicker-orient-right datepicker-orient-left"),
            this.o.orientation.x !== "auto" ? (this.picker.addClass("datepicker-orient-" + this.o.orientation.x),
            this.o.orientation.x === "right" && (t -= f - o)) : u.left < 0 ? (this.picker.addClass("datepicker-orient-left"),
        ...
        fillMonths: function() {
            for (var t = this._utc_to_local(this.viewDate), i = "", u, n = 0; n < 12; n++)
                u = t && t.getMonth() === n ? " focused" : "",
                i += '<span class="month' + u + '">' + r[this.o.language].monthsShort[n] + "<\/span>";
        ...
        _fill_yearsView: function(i, r, u, f, e, o, s) {
            for (var w = "", c = u / 10, b = this.picker.find(i), v = Math.floor(f / u) * u, p = v + c * 9, k = Math.floor(this.viewDate.getFullYear() / c) * c, d = n.map(this.dates, function(n) {
                return Math.floor(n.getUTCFullYear() / c) * c
            }), l, y, h, a = v - c; a <= p + c; a += c)
                l = [r],
                y = null,
                a === v - c ? l.push("old") : a === p + c && l.push("new"),
                n.inArray(a, d) !== -1 && l.push("active"),
                (a < e || a > o) && l.push("disabled"),
                a === k && l.push("focused"),
                s !== n.noop && (h = s(new Date(a,0,1)),
                h === t ? h = {} : typeof h == "boolean" ? h = {
                    enabled: h
                } : typeof h == "string" && (h = {
                    classes: h
                }),
                h.enabled === !1 && l.push("disabled"),
                h.classes && (l = l.concat(h.classes.split(/\s+/))),
                h.tooltip && (y = h.tooltip)),
                w += '<span class="' + l.join(" ") + '"' + (y ? ' title="' + y + '"' : "") + ">" + a + "<\/span>";
            b.find(".datepicker-switch").text(v + "-" + p);
            b.find("td").html(w)
        },
        fill: function() {
            var b = new Date(this.viewDate), s = b.getUTCFullYear(), nt = b.getUTCMonth(), v = this.o.startDate !== -Infinity ? this.o.startDate.getUTCFullYear() : -Infinity, et = this.o.startDate !== -Infinity ? this.o.startDate.getUTCMonth() : -Infinity, y = this.o.endDate !== Infinity ? this.o.endDate.getUTCFullYear() : Infinity, ot = this.o.endDate !== Infinity ? this.o.endDate.getUTCMonth() : Infinity, st = r[this.o.language].today || r.en.today || "", ht = r[this.o.language].clear || r.en.clear || "", ct = r[this.o.language].titleFormat || r.en.titleFormat, k = o(), lt = (this.o.todayBtn === !0 || this.o.todayBtn === "linked") && k >= this.o.startDate && k <= this.o.endDate && !this.weekOfDateIsDisabled(k), p, u, e, tt, c, l, w, h, g, ut, a, ft;
            if (!isNaN(s) && !isNaN(nt)) {
                for (this.picker.find(".datepicker-days .datepicker-switch").text(i.formatDate(b, ct, this.o.language)),
                this.picker.find("tfoot .today").text(st).css("display", lt ? "table-cell" : "none"),
                this.picker.find("tfoot .clear").text(ht).css("display", this.o.clearBtn === !0 ? "table-cell" : "none"),
                this.picker.find("thead .datepicker-title").text(this.o.title).css("display", typeof this.o.title == "string" && this.o.title !== "" ? "table-cell" : "none"),
                this.updateNavArrows(),
                this.fillMonths(),
                e = f(s, nt, 0),
                tt = e.getUTCDate(),
                e.setUTCDate(tt - (e.getUTCDay() - this.o.weekStart + 7) % 7),
                c = new Date(e),
                ...
                l = []; e.valueOf() < c; ) {
                    if (w = e.getUTCDay(),
                    w === this.o.weekStart && (l.push("<tr>"),
                    this.o.calendarWeeks)) {
                        var it = new Date(+e + (this.o.weekStart - w - 7) % 7 * 864e5)
                          , rt = new Date(Number(it) + (11 - it.getUTCDay()) % 7 * 864e5)
                          , d = new Date(Number(d = f(rt.getUTCFullYear(), 0, 1)) + (11 - d.getUTCDay()) % 7 * 864e5)
                          , at = (rt - d) / 6048e5 + 1;
                        l.push('<td class="cw">' + at + "<\/td>")
                    }
                    h = this.getClassNames(e);
                    h.push("day");
                    g = e.getUTCDate();
                    this.o.beforeShowDay !== n.noop && (u = this.o.beforeShowDay(this._utc_to_local(e)),
                    u === t ? u = {} : typeof u == "boolean" ? u = {
                        enabled: u
                    } : typeof u == "string" && (u = {
                        classes: u
                    }),
                    u.enabled === !1 && h.push("disabled"),
                    u.classes && (h = h.concat(u.classes.split(/\s+/))),
                    u.tooltip && (p = u.tooltip),
                    u.content && (g = u.content));
                    h = n.isFunction(n.uniqueSort) ? n.uniqueSort(h) : n.unique(h);
                    l.push('<td class="' + h.join(" ") + '"' + (p ? ' title="' + p + '"' : "") + ' data-date="' + e.getTime().toString() + '">' + g + "<\/td>");
                    p = null;
                    w === this.o.weekEnd && l.push("<\/tr>");
                    e.setUTCDate(e.getUTCDate() + 1)
                }
                this.picker.find(".datepicker-days tbody").html(l.join(""));
                ut = r[this.o.language].monthsTitle || r.en.monthsTitle || "Months";
                a = this.picker.find(".datepicker-months").find(".datepicker-switch").text(this.o.maxViewMode < 2 ? ut : s).end().find("tbody span").removeClass("active");
                n.each(this.dates, function(n, t) {
                    t.getUTCFullYear() === s && a.eq(t.getUTCMonth()).addClass("active")
                });
                (s < v || s > y) && a.addClass("disabled");
                s === v && a.slice(0, et).addClass("disabled");
                s === y && a.slice(ot + 1).addClass("disabled");
                this.o.beforeShowMonth !== n.noop && (ft = this,
                n.each(a, function(i, r) {
                    var f = new Date(s,i,1)
                      , u = ft.o.beforeShowMonth(f);
                    u === t ? u = {} : typeof u == "boolean" ? u = {
                        enabled: u
                    } : typeof u == "string" && (u = {
                        classes: u
                ...
                this._fill_yearsView(".datepicker-years", "year", 10, s, v, y, this.o.beforeShowYear);
                this._fill_yearsView(".datepicker-decades", "decade", 100, s, v, y, this.o.beforeShowDecade);
                this._fill_yearsView(".datepicker-centuries", "century", 1e3, s, v, y, this.o.beforeShowCentury)
            }
        },
        updateNavArrows: function() {
            if (this._allow_update) {
                var u = new Date(this.viewDate), t = u.getUTCFullYear(), f = u.getUTCMonth(), e = this.o.startDate !== -Infinity ? this.o.startDate.getUTCFullYear() : -Infinity, s = this.o.startDate !== -Infinity ? this.o.startDate.getUTCMonth() : -Infinity, o = this.o.endDate !== Infinity ? this.o.endDate.getUTCFullYear() : Infinity, h = this.o.endDate !== Infinity ? this.o.endDate.getUTCMonth() : Infinity, i, r, n = 1;
        ...
        click: function(t) {
            ...
            this._setDate(o(), this.o.todayBtn === "linked" ? null : "view"));
            ...
            s = 1,
            this.viewMode === 1 ? (e = r.parent().find("span").index(r),
        ...
        navArrowsClick: function(t) {
            ...
            this.viewMode !== 0 && (r *= i.viewModes[this.viewMode].navStep * 12);
        ...
        _setDate: function(n, t) {
            ...
            (!t && this.o.updateViewDate || t === "view") && (this.viewDate = n && new Date(n));
            this.fill();
            this.setValue();
        ...
        moveMonth: function(n, t) {
            ...
            if (!t)
                return n;
            var i = new Date(n.valueOf()), e = i.getUTCDate(), o = i.getUTCMonth(), s = Math.abs(t), r, u;
            if (t = t > 0 ? 1 : -1,
            s === 1)
                u = t === -1 ? function() {
        ...
        keydown: function(n) {
            ...
            var u = !1, t, i, r = this.focusDate || this.viewDate;
            switch (n.keyCode) {
            case 27:
            ...
            case 40:
                ...
                this.viewMode === 0 ? n.ctrlKey ? (i = this.moveAvailableDate(r, t, "moveYear"),
                i && this._trigger("changeYear", this.viewDate)) : n.shiftKey ? (i = this.moveAvailableDate(r, t, "moveMonth"),
                i && this._trigger("changeMonth", this.viewDate)) : n.keyCode === 37 || n.keyCode === 39 ? i = this.moveAvailableDate(r, t, "moveDay") : this.weekOfDateIsDisabled(r) || (i = this.moveAvailableDate(r, t, "moveWeek")) : this.viewMode === 1 ? ((n.keyCode === 38 || n.keyCode === 40) && (t = t * 4),
                i = this.moveAvailableDate(r, t, "moveMonth")) : this.viewMode === 2 && ((n.keyCode === 38 || n.keyCode === 40) && (t = t * 4),
            ...
            e !== t)) {
                ...
                if (o !== -1) {
                    if (n.each(this.pickers, function(n, t) {
                        t.getUTCDate() || t !== e && s || t.setUTCDate(r)
                    }),
                    r < this.dates[u])
                        while (u >= 0 && r < this.dates[u] && (this.pickers[u].element.val() || "").length > 0)
                            this.pickers[u--].setUTCDate(r);
                    else if (r > this.dates[f])
                        while (f < h && r > this.dates[f] && (this.pickers[f].element.val() || "").length > 0)
    ...
    s = function(i) {
        ...
        this.each(function() {
            ...
            typeof i == "string" && typeof t[i] == "function" && (r = t[i].apply(t, f))
        }),
    ...
    i = {
        ...
        parseFormat: function(n) {
            if (typeof n.toValue == "function" && typeof n.toDisplay == "function")
                return n;
        ...
        parseDate: function(f, e, s, h) {
            ...
            var tt, g, l, y, it, c, rt, v, ft, d, w;
            if (!f)
                return t;
            if (f instanceof Date)
                return f;
            if (typeof e == "string" && (e = i.parseFormat(e)),
            e.toValue)
            ...
            l.length === v.length) {
                ...
                ft = v.length; c < ft; c++) {
                    ...
                    isNaN(p))
                        switch (y) {
                        case "MM":
                            k = n(r[s].months).filter(ut);
                            p = n.inArray(k[0], r[s].months) + 1;
                            break;
                        case "M":
                            k = n(r[s].monthsShort).filter(ut);
        ...
        formatDate: function(t, u, f) {
            ...
            if (!t)
                return "";
            if (typeof u == "string" && (u = i.parseFormat(u)),
            u.toDisplay)
...
blockUICss = {
    ...
    message: "<span class='fa fa-spinner fa-pulse fa-2x'><\/span> <br /> Yükleniyor..."
};
$("body").on("click", "#forgottenButton", function() {
    validateEmail($("#forgottenEmail").val()) ? ($("#forgottenButton").attr("disabled", "disabled"),
    $.blockUI({
        css: {
            border: "none",
...
$(document).ready(function() {
    $("#loginPopover").popover({
        ...
        trigger: "click",
        sanitize: !1,
        content: '<div class="row px-5 pt-5"><label for="username" class="innerPopover mb-0">' + mailTCPhoneText + '<\/label><input type="text" class= "form-control only-bottom p-0 h-auto" id="username" name="username"><\/div><div class="row px-5 py-2"><label for="password" class="innerPopover mb-0">' + passwordText + '<\/label><input type="password" class= "form-control only-bottom p-0 h-auto" id="password" name="password"><\/div><div class="row pt-2 text-center d-block"><button type="button" class="btn btn-success px-5" onclick="Login()">' + loginText + '<\/button><\/div><div class="row text-center d-block pt-2"><div class="row px-5 py-2 text-right d-block"><b><a href="javascript:void(0)" onclick="ForgotPassword()" style="color:inherit; text-decoration: none;"><span class="forgotPopover">' + forgotPasswordText + "<\/span><\/a><\/b><\/div><\/div>"
    })
});
/*!
  ...
  */
!function(n, t) {
    "object" == typeof exports && "undefined" != typeof module ? t(exports, require("jquery")) : "function" == typeof define && define.amd ? define(["exports", "jquery"], t) : t((n = n || self)["bootstrap-drawer"] = {}, n.jQuery)
}(this, function(n, t) {
    "use strict";
    function v(n, t) {
        for (var i, r = 0; r < t.length; r++)
    ...
    var f = "drawer"
      ...
      , g = "drawer-content-scrollable"
      , nt = "drawer-scrollbar-measure"
      , tt = "drawer-backdrop"
      , s = "slide"
      , it = "fade"
      , c = "show"
      ...
      , h = function() {
        function e(n, t) {
            this._config = this._getConfig(t);
            this._element = n;
            this._content = n.querySelector(rt);
            this._backdrop = null;
            this._isShown = !1;
            this._isBodyOverflowing = !1;
            this._ignoreBackdropClick = !1;
        ...
        n.show = function(n) {
            ...
            this._setScrollbar(),
            this._setEscapeEvent(),
            t(this._element).on(i.CLICK_DISMISS, ft, function(n) {
                return r.hide(n)
            }),
            t(this._content).on(i.MOUSEDOWN_DISMISS, function() {
        ...
        n._showElement = function(n) {
            ...
            var u = this, f = t(this._element).hasClass(s), o, h;
            this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element);
            this._element.style.display = "block";
            this._element.removeAttribute("aria-hidden");
            this._element.setAttribute("aria-modal", !0);
            t(this._content).hasClass(g) ? this._content.querySelector(ut).scrollTop = 0 : this._element.scrollTop = 0;
            ...
            f ? (h = r.getTransitionDurationFromElement(this._element),
            t(this._element).one(r.TRANSITION_END, e).emulateTransitionEnd(h)) : e()
        }
        ,
        n._enforceFocus = function() {
            var n = this;
            t(document).off(i.FOCUSIN).on(i.FOCUSIN, function(i) {
                document !== i.target && n._element !== i.target && 0 === t(n._element).has(i.target).length && n._element.focus()
            })
        }
        ,
        n._setEscapeEvent = function() {
            var n = this;
            this._isShown && this._config.keyboard ? t(document.body).on(i.KEYDOWN_DISMISS, function(t) {
                27 === t.which && (t.preventDefault(),
                n.hide())
            }) : this._isShown || t(document.body).off(i.KEYDOWN_DISMISS)
        }
        ,
        n._hideDrawer = function() {
            var n = this;
            this._element.style.display = "none";
            this._element.setAttribute("aria-hidden", !0);
            this._element.removeAttribute("aria-modal");
        ...
        ,
        n._showBackdrop = function(n) {
            var u = this, f = t(this._element).hasClass(s) ? it : "", o, e, h;
            if (this._isShown && this._config.backdrop) {
                if (this._backdrop = document.createElement("div"),
                this._backdrop.className = tt,
                f && this._backdrop.classList.add(f),
                t(this._backdrop).appendTo(document.body),
                t(this._backdrop).on(i.CLICK_DISMISS, function(n) {
                ...
                !this._isShown && this._backdrop ? (t(this._backdrop).removeClass(c),
                e = function() {
                    u._removeBackdrop();
                    n && n()
                }
                ,
                t(this._element).hasClass(s) ? (h = r.getTransitionDurationFromElement(this._backdrop),
                t(this._backdrop).one(r.TRANSITION_END, e).emulateTransitionEnd(h)) : e()) : n && n()
        }
        ,
        n._resetAdjustments = function() {
            this._element.style.paddingLeft = "";
        ...
        n._setScrollbar = function() {
            var n = this, i, r, u, f;
            this._isBodyOverflowing && (i = [].slice.call(document.querySelectorAll(p)),
            r = [].slice.call(document.querySelectorAll(w)),
            t(i).each(function(i, r) {
                var u = r.style.paddingRight
                  , f = t(r).css("padding-right");
                t(r).data("padding-right", u).css("padding-right", parseFloat(f) + n._scrollbarWidth + "px")
            ...
            f = t(document.body).css("padding-right"),
            t(document.body).data("padding-right", u).css("padding-right", parseFloat(f) + this._scrollbarWidth + "px"));
            t(document.body).addClass(y)
        }
        ,
        n._resetScrollbar = function() {
            var r = [].slice.call(document.querySelectorAll(p)), n, i;
            t(r).each(function(n, i) {
                var r = t(i).data("padding-right");
                t(i).removeData("padding-right");
                i.style.paddingRight = r || ""
            });
            n = [].slice.call(document.querySelectorAll("" + w));
            t(n).each(function(n, i) {
                var r = t(i).data("margin-right");
                "undefined" != typeof r && t(i).css("margin-right", r).removeData("margin-right")
            });
        ...
        e._jQueryInterface = function(n, i) {
            return this.each(function() {
                var r = t(this).data(o)
                  , u = l({}, a, t(this).data(), "object" == typeof n && n ? n : {});
                if (r || (r = new e(this,u),
                t(this).data(o, r)),
                "string" == typeof n) {
    ...
    t(document).on(i.CLICK_DATA_API, '[data-toggle="drawer"]', function(n) {
        var u, f = this, e = r.getSelectorFromElement(this), s, c;
        e && (u = document.querySelector(e));
        s = t(u).data(o) ? "toggle" : l({}, t(u).data(), t(this).data());
        "A" !== this.tagName && "AREA" !== this.tagName || n.preventDefault();
        c = t(u).one(i.SHOW, function(n) {
            n.isDefaultPrevented() || c.one(i.HIDDEN, function() {
                t(f).is(":visible") && f.focus()
            })
        });
        h._jQueryInterface.call(t(u), s, this)
    });
    t.fn[f] = h._jQueryInterface;
    t.fn[f].Constructor = h;
...
$("#tcidentity").blur(function() {
    $("#uyruk").val() == 0 && (CheckTcNo($(this).val()) ? $.ajax({
        ...
        success: function(n) {
            n != null && n.isSuccess ? ($("#adi").val(n.data.name),
            $("#soyadi").val(n.data.lastName),
            $("#birthdate").val(n.data.birthDay.replace(".", "/").replace(".", "/").replace("00:00:00", "")),
            $("#cinsiyet").val(n.data.gender)) : (ShowErrorMessage(n.statusMessage),
            $("#adi").val(""),
            $("#soyadi").val(""),
            $("#birthdate").val(""),
            $("#cinsiyet").val(""),
...
function(n, t, i) {
    ...
    (function r(n, t, i) {
        function u(f, o) {
            ...
            if (!t[f]) {
                if (!n[f]) {
                    if (h = typeof require == "function" && require,
                    !o && h)
                        return h(f, !0);
                    if (e)
                        return e(f, !0);
        ...
        for (var e = typeof require == "function" && require, f = 0; f < i.length; f++)
            u(i[f]);
        return u
    }
    )({
        1: [function(r, u, f) {
            ...
            var e = r("./modules/handle-dom"), c = r("./modules/utils"), o = r("./modules/handle-swal-dom"), p = r("./modules/handle-click"), w = r("./modules/handle-key"), b = v(w), k = r("./modules/default-params"), l = v(k), d = r("./modules/set-params"), g = v(d), y, a, s, h;
            f["default"] = s = h = function() {
                function k(n) {
                    var t = u;
                    return t[n] === i ? l["default"][n] : t[n]
                }
                var u = arguments[0], r, v, f, s, it, rt;
                if (e.addClass(t.body, "stop-scrolling"),
                o.resetInput(),
                u === i)
                    return c.logStr("SweetAlert expects at least 1 attribute!"),
                ...
                o.openModal(arguments[1]);
                var w = o.getModal()
                  , d = w.querySelectorAll("button")
                  , nt = ["onclick", "onmouseover", "onmouseout", "onmousedown", "onmouseup", "onfocus"]
                  , tt = function(n) {
                    return p.handleButton(n, r, w)
                };
            ...
            ;
            typeof n != "undefined" ? n.sweetAlert = n.swal = s : c.logStr("SweetAlert is a frontend module!");
            u.exports = f["default"]
        }
        , {
            "./modules/default-params": 2,
        ...
        3: [function(t, i, r) {
            ...
            var f = t("./utils")
              ...
              , s = function(t, i, r) {
                function l(n) {
                    h && i.confirmButtonColor && (s.style.backgroundColor = n)
                }
                var a = t || n.event, s = a.target || a.srcElement, h = s.className.indexOf("confirm") !== -1, nt = s.className.indexOf("sweet-overlay") !== -1, v = u.hasClass(r, "visible"), p = i.doneFunction && r.getAttribute("data-has-done-function") === "true", c, y, w, b, k, d, g;
                h && i.confirmButtonColor && (c = i.confirmButtonColor,
                y = f.colorLuminance(c, -.04),
                w = f.colorLuminance(c, -.14));
                switch (a.type) {
                case "mouseover":
                    l(y);
                    break;
                ...
                case "focus":
                    b = r.querySelector("button.confirm");
                    k = r.querySelector("button.cancel");
                    h ? k.style.boxShadow = "none" : b.style.boxShadow = "none";
                    break;
                case "click":
                    if (d = r === s,
                    g = u.isDescendant(r, s),
                    !d && !g && v && !i.allowOutsideClick)
                        break;
                    h && p && v ? e(r, i) : p && v || nt ? o(r, i) : u.isDescendant(r, s) && s.tagName === "BUTTON" && sweetAlert.close()
                }
            }
              , e = function(n, t) {
                var i = !0;
              ...
              , o = function(n, t) {
                var i = String(t.doneFunction).replace(/\s/g, "")
                  , r = i.substring(0, 9) === "function(" && i.substring(9, 10) !== ")";
                r && t.doneFunction(!1);
                t.closeOnCancel && sweetAlert.close()
            };
            r["default"] = {
        ...
        4: [function(i, r, u) {
            ...
            var f = function(n, t) {
              ...
              , y = function(n) {
                n.style.left = "-9999px";
                n.style.display = "block";
                var i = n.clientHeight, t;
                return t = typeof getComputedStyle != "undefined" ? parseInt(getComputedStyle(n).getPropertyValue("padding-top"), 10) : parseInt(n.currentStyle.padding),
                n.style.left = "",
                n.style.display = "none",
                "-" + parseInt((i + t) / 2) + "px"
            }
              ...
              , b = function(i) {
                var u, r;
                typeof MouseEvent == "function" ? (u = new MouseEvent("click",{
                    view: n,
                    bubbles: !1,
                    cancelable: !0
                }),
                i.dispatchEvent(u)) : t.createEvent ? (r = t.createEvent("MouseEvents"),
                r.initEvent("click", !1, !1),
                i.dispatchEvent(r)) : t.createEventObject ? i.fireEvent("onclick") : typeof i.onclick == "function" && i.onclick()
            }
              , k = function(t) {
        ...
        5: [function(t, r, u) {
            ...
            var f = t("./handle-dom")
              , e = t("./handle-swal-dom")
              , o = function(t, r, u) {
                var s = t || n.event, a = s.keyCode || s.which, v = u.querySelector("button.confirm"), y = u.querySelector("button.cancel"), c = u.querySelectorAll("button[tabindex]"), o, h, l;
                if ([9, 13, 32, 27].indexOf(a) !== -1) {
                    for (o = s.target || s.srcElement,
                    h = -1,
                    l = 0; l < c.length; l++)
                        if (o === c[l]) {
                            h = l;
                    ...
                    a === 9 ? (o = h === -1 ? v : h === c.length - 1 ? c[0] : c[h + 1],
                    f.stopEventPropagation(s),
                    o.focus(),
                    r.confirmButtonColor && e.setFocusStyle(o, r.confirmButtonColor)) : a === 13 ? (o.tagName === "INPUT" && (o = v,
                    v.focus()),
                    o = h === -1 ? v : i) : a === 27 && r.allowEscapeKey === !0 ? (o = y,
                    f.fireClick(o, s)) : o = i
                }
            };
            u["default"] = o;
        ...
        6: [function(i, r, u) {
            ...
            var v = i("./utils")
              ...
              , g = function(i) {
                ...
                u !== "null" && u !== "" && (o = i,
                r.timeout = setTimeout(function() {
                    var n = (o || null) && r.getAttribute("data-has-done-function") === "true";
                    n ? o(null) : sweetAlert.close()
                }, u))
            }
              , nt = function() {
            ...
            var o = n("./utils")
              ...
              , s = function(n) {
                ...
                n.type && !o.isIE8() && (c = function() {
                    ...
                    c = ["success", "error", "warning", "info"];
                    r = i;
                    c.indexOf(n.type) !== -1 && (r = t.querySelector(".sa-icon.sa-" + n.type),
                    u.show(r));
                    o = f.getInput();
                    switch (n.type) {
                    case "success":
                ...
                k = n.doneFunction ? !0 : !1;
                t.setAttribute("data-has-done-function", k);
                n.animation ? typeof n.animation == "string" ? t.setAttribute("data-animation", n.animation) : t.setAttribute("data-animation", "pop") : t.setAttribute("data-animation", "none");
                t.setAttribute("data-timer", n.timer)
            };
            r["default"] = s;
            t.exports = r["default"]
        ...
        9: [function(t, i, r) {
            ...
            var u = function(n, t) {
              ...
              , s = function(n, t) {
                ...
                n.length < 6 && (n = n[0] + n[0] + n[1] + n[1] + n[2] + n[2]);
                t = t || 0;
                for (var u = "#", i, r = 0; r < 3; r++)
                    i = parseInt(n.substr(r * 2, 2), 16),
                    i = Math.round(Math.min(Math.max(0, i + i * t), 255)).toString(16),
                    u += ("00" + i).substr(i.length);
                return u
            };
    ...
    typeof define == "function" && define.amd ? define(function() {
        return sweetAlert
    }) : typeof module != "undefined" && module.exports && (module.exports = sweetAlert)
}(window, document);
